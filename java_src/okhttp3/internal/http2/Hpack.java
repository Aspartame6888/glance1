...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        public Reader(fc4 fc4Var, int i) {
            this(fc4Var, i, 0, 4, null);
        ...
        private final ByteString getName(int i) {
            ...
            throw new IOException(dx1.k(Integer.valueOf(i + 1), "Header index too large "));
        }
        ...
        public final List<Header> getAndResetHeaderList() {
            List<Header> d0 = c.d0(this.headerList);
        ...
        public final ByteString readByteString() {
            ...
            if (z) {
                bp bpVar = new bp();
                Huffman.INSTANCE.decode(this.source, readInt, bpVar);
                return bpVar.M0();
            }
            return this.source.p0(readInt);
        }
                ...
                if (and != 128) {
                    if ((and & 128) == 128) {
                        ...
                        if (readInt >= 0 && readInt <= this.headerTableSizeSetting) {
                            ...
                            throw new IOException(dx1.k(Integer.valueOf(this.maxDynamicTableByteCount), "Invalid dynamic table size update "));
                        }
        ...
        public Reader(fc4 fc4Var, int i, int i2) {
            dx1.f(fc4Var, FirebaseAnalytics.Param.SOURCE);
            this.headerTableSizeSetting = i;
            this.maxDynamicTableByteCount = i2;
            this.headerList = new ArrayList();
            this.source = q11.e(fc4Var);
            this.dynamicTable = new Header[8];
            this.nextHeaderIndex = 7;
        }

        public /* synthetic */ Reader(fc4 fc4Var, int i, int i2, int i3, di0 di0Var) {
            this(fc4Var, i, (i3 & 4) != 0 ? i : i2);
        }
    }

    /* compiled from: Hpack.kt */
    @Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0011\n\u0002\b\b\u0018\u00002\u00020\u0001B%\b\u0007\u0012\b\b\u0002\u0010\u0015\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0019\u001a\u00020\u0018\u0012\u0006\u0010\u001c\u001a\u00020\u001b¢\u0006\u0004\b'\u0010(J\b\u0010\u0003\u001a\u00020\u0002H\u0002J\u0010\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004H\u0002J\u0010\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007H\u0002J\b\u0010\n\u001a\u00020\u0002H\u0002J\u0014\u0010\r\u001a\u00020\u00022\f\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u00070\u000bJ\u001e\u0010\u0011\u001a\u00020\u00022\u0006\u0010\u000e\u001a\u00020\u00042\u0006\u0010\u000f\u001a\u00020\u00042\u0006\u0010\u0010\u001a\u00020\u0004J\u000e\u0010\u0014\u001a\u00020\u00022\u0006\u0010\u0013\u001a\u00020\u0012J\u000e\u0010\u0016\u001a\u00020\u00022\u0006\u0010\u0015\u001a\u00020\u0004R\u0016\u0010\u0015\u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u0015\u0010\u0017R\u0014\u0010\u0019\u001a\u00020\u00188\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010\u001aR\u0014\u0010\u001c\u001a\u00020\u001b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001c\u0010\u001dR\u0016\u0010\u001e\u001a\u00020\u00048\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001e\u0010\u0017R\u0016\u0010\u001f\u001a\u00020\u00188\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001f\u0010\u001aR\u0016\u0010 \u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b \u0010\u0017R\u001e\u0010\"\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00070!8\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\"\u0010#R\u0016\u0010$\u001a\u00020\u00048\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b$\u0010\u0017R\u0016\u0010%\u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b%\u0010\u0017R\u0016\u0010&\u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b&\u0010\u0017¨\u0006)"}, d2 = {"Lokhttp3/internal/http2/Hpack$Writer;", "", "Lcom/zapp/oneweatherzapp/k55;", "clearDynamicTable", "", "bytesToRecover", "evictToRecoverBytes", "Lokhttp3/internal/http2/Header;", "entry", "insertIntoDynamicTable", "adjustDynamicTableByteCount", "", "headerBlock", "writeHeaders", FirebaseAnalytics.Param.VALUE, "prefixMask", "bits", "writeInt", "Lokio/ByteString;", "data", "writeByteString", "headerTableSizeSetting", "resizeHeaderTable", "I", "", "useCompression", "Z", "Lcom/zapp/oneweatherzapp/bp;", "out", "Lcom/zapp/oneweatherzapp/bp;", "smallestHeaderTableSizeSetting", "emitDynamicTableSizeUpdate", "maxDynamicTableByteCount", "", "dynamicTable", "[Lokhttp3/internal/http2/Header;", "nextHeaderIndex", "headerCount", "dynamicTableByteCount", "<init>", "(IZLcom/zapp/oneweatherzapp/bp;)V", "okhttp"}, k = 1, mv = {1, 6, 0})
    /* loaded from: classes2.dex */
    public static final class Writer {
        ...
        private int nextHeaderIndex;
        private final bp out;
        private int smallestHeaderTableSizeSetting;
        private final boolean useCompression;

        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public Writer(int i, bp bpVar) {
            this(i, false, bpVar, 2, null);
            dx1.f(bpVar, "out");
        }
        ...
        public final void writeByteString(ByteString byteString) {
            ...
            if (this.useCompression) {
                ...
                if (huffman.encodedLength(byteString) < byteString.size()) {
                    bp bpVar = new bp();
                    huffman.encode(byteString, bpVar);
                    ByteString M0 = bpVar.M0();
                    writeInt(M0.size(), 127, 128);
                    this.out.n0(M0);
                    return;
                }
            }
            writeInt(byteString.size(), 127, 0);
            this.out.n0(byteString);
        }
        ...
        public final void writeHeaders(List<Header> list) {
            ...
            while (i4 < size) {
                ...
                if (num != null) {
                    ...
                    if (z) {
                        if (dx1.a(hpack.getSTATIC_HEADER_TABLE()[i2 - 1].value, byteString)) {
                            i = i2;
                        } else if (dx1.a(hpack.getSTATIC_HEADER_TABLE()[i2].value, byteString)) {
                            i2++;
                            i = i2;
                        }
                    }
                ...
                if (i2 == -1) {
                    ...
                    while (true) {
                        ...
                        dx1.c(header2);
                        if (dx1.a(header2.name, asciiLowercase)) {
                            Header header3 = this.dynamicTable[i6];
                            dx1.c(header3);
                            if (dx1.a(header3.value, byteString)) {
                ...
                } else if (asciiLowercase.startsWith(Header.PSEUDO_PREFIX) && !dx1.a(Header.TARGET_AUTHORITY, asciiLowercase)) {
                    writeInt(i, 15, 0);
                    writeByteString(byteString);
                } else {
                    writeInt(i, 63, 64);
        ...
        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public Writer(bp bpVar) {
            this(0, false, bpVar, 3, null);
            dx1.f(bpVar, "out");
        }

        public Writer(int i, boolean z, bp bpVar) {
            dx1.f(bpVar, "out");
            this.headerTableSizeSetting = i;
        ...
        public /* synthetic */ Writer(int i, boolean z, bp bpVar, int i2, di0 di0Var) {
            this((i2 & 1) != 0 ? 4096 : i, (i2 & 2) != 0 ? true : z, bpVar);
        }
    }
    ...
    private final Map<ByteString, Integer> nameToFirstIndex() {
        ...
        dx1.e(unmodifiableMap, "unmodifiableMap(result)");
    ...
    public final ByteString checkLowercase(ByteString byteString) {
        ...
        while (i < size) {
            ...
            if (!z) {
                ...
                throw new IOException(dx1.k(byteString.utf8(), "PROTOCOL_ERROR response malformed: mixed case name: "));
            }
        }
        return byteString;
    }
