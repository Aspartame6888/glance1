...
public class IidStore {
    ...
    private static String getIdFromPublicKey(PublicKey publicKey) {
        try {
            ...
            digest[0] = (byte) (((digest[0] & 15) + ZappWidgetId.L0_ID_GAMES_FEATURED_GAMES_MD_V1_VALUE) & 255);
            return Base64.encodeToString(digest, 0, 8, 11);
        } catch (NoSuchAlgorithmException unused) {
            mu0.h("ContentValues", "Unexpected error, device missing required algorithms");
            return null;
        }
    }
    ...
    private PublicKey parseKey(String str) {
        try {
            ...
            mu0.h("ContentValues", "Invalid key stored " + e);
            return null;
        }
    }
