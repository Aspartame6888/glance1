...
import com.zapp.oneweatherzapp.a06;
import com.zapp.oneweatherzapp.b06;
import com.zapp.oneweatherzapp.c06;
import com.zapp.oneweatherzapp.c16;
import com.zapp.oneweatherzapp.ca6;
import com.zapp.oneweatherzapp.d06;
...
import com.zapp.oneweatherzapp.u06;
import com.zapp.oneweatherzapp.yz5;
import com.zapp.oneweatherzapp.zz5;
...
public final class FirebaseAnalytics {
    ...
    public FirebaseAnalytics(k26 k26Var) {
        kh3.h(k26Var);
        this.zzb = k26Var;
    }
    ...
    public static FirebaseAnalytics getInstance(Context context) {
        if (zza == null) {
            synchronized (FirebaseAnalytics.class) {
                if (zza == null) {
                    zza = new FirebaseAnalytics(k26.f(context, null));
                }
            }
        }
        return zza;
    ...
    @Keep
    public static ca6 getScionFrontendApiImplementation(Context context, Bundle bundle) {
        k26 f = k26.f(context, bundle);
        if (f == null) {
            return null;
        }
        return new zzc(f);
    ...
    public np4<String> getAppInstanceId() {
        ...
        try {
            ...
            return fq4.c(executorService, new zzb(this));
        } catch (RuntimeException e) {
            k26 k26Var = this.zzb;
            k26Var.getClass();
            k26Var.d(new u06(k26Var, "Failed to schedule task for getAppInstanceId", null));
            return fq4.d(e);
        }
    }
    ...
    public String getFirebaseInstanceId() {
        try {
            return (String) fq4.b(FirebaseInstallations.getInstance().getId(), TimeUnit.MILLISECONDS);
    ...
    public void logEvent(String str, Bundle bundle) {
        this.zzb.c(null, str, bundle, false, true, null);
    }

    public void resetAnalyticsData() {
        k26 k26Var = this.zzb;
        k26Var.getClass();
        k26Var.d(new c06(k26Var));
    }
    ...
    public void setAnalyticsCollectionEnabled(boolean z) {
        ...
        k26Var.getClass();
        k26Var.d(new a06(k26Var, valueOf));
    }
    ...
    public void setConsent(Map<ConsentType, ConsentStatus> map) {
        ...
        k26 k26Var = this.zzb;
        k26Var.getClass();
        k26Var.d(new b06(k26Var, bundle));
    }
    ...
    public void setCurrentScreen(Activity activity, String str, String str2) {
        k26 k26Var = this.zzb;
        k26Var.getClass();
        k26Var.d(new zz5(k26Var, activity, str, str2));
    }

    public void setDefaultEventParameters(Bundle bundle) {
        k26 k26Var = this.zzb;
        k26Var.getClass();
        k26Var.d(new c16(k26Var, bundle));
    }

    public void setSessionTimeoutDuration(long j) {
        k26 k26Var = this.zzb;
        k26Var.getClass();
        k26Var.d(new d06(k26Var, j));
    }

    public void setUserId(String str) {
        k26 k26Var = this.zzb;
        k26Var.getClass();
        k26Var.d(new yz5(k26Var, str));
    }

    public void setUserProperty(String str, String str2) {
        k26 k26Var = this.zzb;
        k26Var.getClass();
        k26Var.d(new j16(k26Var, null, str, str2, false));
    }
}
