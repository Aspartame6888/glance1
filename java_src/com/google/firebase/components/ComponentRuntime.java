...
import com.zapp.oneweatherzapp.f30;
...
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
    private static final Provider<Set<Object>> EMPTY_PROVIDER = new f30();
        ...
        synchronized (this) {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    it.remove();
                    mu0.i("ComponentDiscovery", "Invalid component registrar.", e);
                }
            }
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.zapp.oneweatherzapp.d30
    ...
    private static Iterable<Provider<ComponentRegistrar>> toProviders(Iterable<ComponentRegistrar> iterable) {
        ...
        for (final ComponentRegistrar componentRegistrar : iterable) {
            arrayList.add(new Provider() { // from class: com.zapp.oneweatherzapp.e30
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
    ...
    public static final class Builder {
        ...
        public Builder addComponentRegistrar(final ComponentRegistrar componentRegistrar) {
            this.lazyRegistrars.add(new Provider() { // from class: com.zapp.oneweatherzapp.g30
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
