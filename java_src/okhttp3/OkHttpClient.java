...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            dx1.e(socketFactory, "getDefault()");
        ...
        public final Builder m454addInterceptor(final Function110<? super Interceptor.Chain, Response> function110) {
            dx1.f(function110, "block");
            return addInterceptor(new Interceptor() { // from class: okhttp3.OkHttpClient$Builder$addInterceptor$2
                @Override // okhttp3.Interceptor
                public final Response intercept(Interceptor.Chain chain) {
                    dx1.f(chain, "chain");
                    return function110.invoke(chain);
                }
            });
        }

        /* renamed from: -addNetworkInterceptor  reason: not valid java name */
        public final Builder m455addNetworkInterceptor(final Function110<? super Interceptor.Chain, Response> function110) {
            dx1.f(function110, "block");
        ...
        public final Builder authenticator(Authenticator authenticator) {
            dx1.f(authenticator, "authenticator");
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            dx1.f(certificatePinner, "certificatePinner");
            if (!dx1.a(certificatePinner, getCertificatePinner$okhttp())) {
        ...
        public final Builder connectionSpecs(List<ConnectionSpec> list) {
            ...
            if (!dx1.a(list, getConnectionSpecs$okhttp())) {
                setRouteDatabase$okhttp(null);
            }
        ...
        public final Builder cookieJar(CookieJar cookieJar) {
            dx1.f(cookieJar, "cookieJar");
            setCookieJar$okhttp(cookieJar);
            return this;
        }

        public final Builder dispatcher(Dispatcher dispatcher) {
            dx1.f(dispatcher, "dispatcher");
        ...
        public final Builder eventListenerFactory(EventListener.Factory factory) {
            dx1.f(factory, "eventListenerFactory");
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            dx1.f(hostnameVerifier, "hostnameVerifier");
            if (!dx1.a(hostnameVerifier, getHostnameVerifier$okhttp())) {
                setRouteDatabase$okhttp(null);
            }
        ...
        public final Builder minWebSocketMessageToCompress(long j) {
            ...
            throw new IllegalArgumentException(dx1.k(Long.valueOf(j), "minWebSocketMessageToCompress must be positive: ").toString());
        }
                ...
                if (z2) {
                    if (!e0.contains(Protocol.HTTP_1_0)) {
                        if (!e0.contains(null)) {
                            ...
                            if (!dx1.a(e0, getProtocols$okhttp())) {
                                setRouteDatabase$okhttp(null);
                            }
                            List<? extends Protocol> unmodifiableList = Collections.unmodifiableList(e0);
                            dx1.e(unmodifiableList, "unmodifiableList(protocolsCopy)");
                            setProtocols$okhttp(unmodifiableList);
                            return this;
                        }
                        throw new IllegalArgumentException("protocols must not contain null".toString());
                    }
                    throw new IllegalArgumentException(dx1.k(e0, "protocols must not contain http/1.0: ").toString());
                }
                throw new IllegalArgumentException(dx1.k(e0, "protocols containing h2_prior_knowledge cannot use other protocols: ").toString());
            }
            throw new IllegalArgumentException(dx1.k(e0, "protocols must contain h2_prior_knowledge or http/1.1: ").toString());
        }

        public final Builder proxy(Proxy proxy) {
            if (!dx1.a(proxy, getProxy$okhttp())) {
                setRouteDatabase$okhttp(null);
            }
        ...
        public final Builder proxyAuthenticator(Authenticator authenticator) {
            ...
            if (!dx1.a(authenticator, getProxyAuthenticator$okhttp())) {
                setRouteDatabase$okhttp(null);
            }
        ...
        public final Builder proxySelector(ProxySelector proxySelector) {
            ...
            if (!dx1.a(proxySelector, getProxySelector$okhttp())) {
                setRouteDatabase$okhttp(null);
            }
        ...
        public final Builder socketFactory(SocketFactory socketFactory) {
            ...
            if (!(socketFactory instanceof SSLSocketFactory)) {
                if (!dx1.a(socketFactory, getSocketFactory$okhttp())) {
                    setRouteDatabase$okhttp(null);
                }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sSLSocketFactory) {
            dx1.f(sSLSocketFactory, "sslSocketFactory");
            if (!dx1.a(sSLSocketFactory, getSslSocketFactoryOrNull$okhttp())) {
                setRouteDatabase$okhttp(null);
            }
            ...
            if (trustManager != null) {
                ...
                dx1.c(x509TrustManagerOrNull$okhttp);
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sSLSocketFactory, X509TrustManager x509TrustManager) {
            dx1.f(sSLSocketFactory, "sslSocketFactory");
            dx1.f(x509TrustManager, "trustManager");
            if (!dx1.a(sSLSocketFactory, getSslSocketFactoryOrNull$okhttp()) || !dx1.a(x509TrustManager, getX509TrustManagerOrNull$okhttp())) {
                setRouteDatabase$okhttp(null);
            }
            setSslSocketFactoryOrNull$okhttp(sSLSocketFactory);
        ...
        public Builder(OkHttpClient okHttpClient) {
            this();
            dx1.f(okHttpClient, "okHttpClient");
            this.dispatcher = okHttpClient.dispatcher();
            this.connectionPool = okHttpClient.connectionPool();
            lz.t(okHttpClient.interceptors(), this.interceptors);
            lz.t(okHttpClient.networkInterceptors(), this.networkInterceptors);
    ...
    public OkHttpClient(Builder builder) {
        ...
        builder.eventListener(new SentryOkHttpEventListener(builder.getEventListenerFactory$okhttp()));
    ...
    private final void verifyClientState() {
        ...
        if (!this.interceptors.contains(null)) {
                ...
                if (z) {
                    ...
                    if (z2) {
                        ...
                        if (z3) {
                            ...
                            if (z4) {
                                if (!dx1.a(this.certificatePinner, CertificatePinner.DEFAULT)) {
            ...
            throw new IllegalStateException(dx1.k(networkInterceptors(), "Null network interceptor: ").toString());
        }
        throw new IllegalStateException(dx1.k(interceptors(), "Null interceptor: ").toString());
    }

    /* renamed from: -deprecated_authenticator  reason: not valid java name */
    public final Authenticator m428deprecated_authenticator() {
        return this.authenticator;
    }

    /* renamed from: -deprecated_cache  reason: not valid java name */
    public final Cache m429deprecated_cache() {
        return this.cache;
    }

    /* renamed from: -deprecated_callTimeoutMillis  reason: not valid java name */
    public final int m430deprecated_callTimeoutMillis() {
        return this.callTimeoutMillis;
    }

    /* renamed from: -deprecated_certificatePinner  reason: not valid java name */
    public final CertificatePinner m431deprecated_certificatePinner() {
        return this.certificatePinner;
    }

    /* renamed from: -deprecated_connectTimeoutMillis  reason: not valid java name */
    public final int m432deprecated_connectTimeoutMillis() {
        return this.connectTimeoutMillis;
    }

    /* renamed from: -deprecated_connectionPool  reason: not valid java name */
    public final ConnectionPool m433deprecated_connectionPool() {
        return this.connectionPool;
    }

    /* renamed from: -deprecated_connectionSpecs  reason: not valid java name */
    public final List<ConnectionSpec> m434deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }

    /* renamed from: -deprecated_cookieJar  reason: not valid java name */
    public final CookieJar m435deprecated_cookieJar() {
        return this.cookieJar;
    }

    /* renamed from: -deprecated_dispatcher  reason: not valid java name */
    public final Dispatcher m436deprecated_dispatcher() {
        return this.dispatcher;
    }

    /* renamed from: -deprecated_dns  reason: not valid java name */
    public final Dns m437deprecated_dns() {
        return this.dns;
    }

    /* renamed from: -deprecated_eventListenerFactory  reason: not valid java name */
    public final EventListener.Factory m438deprecated_eventListenerFactory() {
        return this.eventListenerFactory;
    }

    /* renamed from: -deprecated_followRedirects  reason: not valid java name */
    public final boolean m439deprecated_followRedirects() {
        return this.followRedirects;
    }

    /* renamed from: -deprecated_followSslRedirects  reason: not valid java name */
    public final boolean m440deprecated_followSslRedirects() {
        return this.followSslRedirects;
    }

    /* renamed from: -deprecated_hostnameVerifier  reason: not valid java name */
    public final HostnameVerifier m441deprecated_hostnameVerifier() {
        return this.hostnameVerifier;
    }

    /* renamed from: -deprecated_interceptors  reason: not valid java name */
    public final List<Interceptor> m442deprecated_interceptors() {
        return this.interceptors;
    }

    /* renamed from: -deprecated_networkInterceptors  reason: not valid java name */
    public final List<Interceptor> m443deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }

    /* renamed from: -deprecated_pingIntervalMillis  reason: not valid java name */
    public final int m444deprecated_pingIntervalMillis() {
        return this.pingIntervalMillis;
    }

    /* renamed from: -deprecated_protocols  reason: not valid java name */
    public final List<Protocol> m445deprecated_protocols() {
        return this.protocols;
    }

    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m446deprecated_proxy() {
        return this.proxy;
    }

    /* renamed from: -deprecated_proxyAuthenticator  reason: not valid java name */
    public final Authenticator m447deprecated_proxyAuthenticator() {
        return this.proxyAuthenticator;
    }

    /* renamed from: -deprecated_proxySelector  reason: not valid java name */
    public final ProxySelector m448deprecated_proxySelector() {
        return this.proxySelector;
    }

    /* renamed from: -deprecated_readTimeoutMillis  reason: not valid java name */
    public final int m449deprecated_readTimeoutMillis() {
        return this.readTimeoutMillis;
    }

    /* renamed from: -deprecated_retryOnConnectionFailure  reason: not valid java name */
    public final boolean m450deprecated_retryOnConnectionFailure() {
        return this.retryOnConnectionFailure;
    }

    /* renamed from: -deprecated_socketFactory  reason: not valid java name */
    public final SocketFactory m451deprecated_socketFactory() {
        return this.socketFactory;
    }

    /* renamed from: -deprecated_sslSocketFactory  reason: not valid java name */
    public final SSLSocketFactory m452deprecated_sslSocketFactory() {
        return sslSocketFactory();
    }

    /* renamed from: -deprecated_writeTimeoutMillis  reason: not valid java name */
    public final int m453deprecated_writeTimeoutMillis() {
