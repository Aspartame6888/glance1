...
public class Platform {
    ...
    public static final class Companion {
        ...
        private final boolean isBouncyCastlePreferred() {
            return dx1.a("BC", Security.getProviders()[0].getName());
        }

        private final boolean isConscryptPreferred() {
            return dx1.a("Conscrypt", Security.getProviders()[0].getName());
        }

        private final boolean isOpenJSSEPreferred() {
            return dx1.a("OpenJSSE", Security.getProviders()[0].getName());
        }
        ...
        public final boolean isAndroid() {
            return dx1.a("Dalvik", System.getProperty("java.vm.name"));
        }

        public final void resetForTests(Platform platform) {
            dx1.f(platform, "platform");
    ...
    public TrustRootIndex buildTrustRootIndex(X509TrustManager x509TrustManager) {
        ...
        dx1.e(acceptedIssuers, "trustManager.acceptedIssuers");
    ...
    public void connectSocket(Socket socket, InetSocketAddress inetSocketAddress, int i) {
        dx1.f(socket, "socket");
        dx1.f(inetSocketAddress, "address");
    ...
    public void logCloseableLeak(String str, Object obj) {
        dx1.f(str, "message");
        if (obj == null) {
            str = dx1.k(" To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);", str);
        }
    ...
    public SSLContext newSSLContext() {
        ...
        dx1.e(sSLContext, "getInstance(\"TLS\")");
        return sSLContext;
    }
    ...
    public SSLSocketFactory newSslSocketFactory(X509TrustManager x509TrustManager) {
        ...
        try {
            ...
            dx1.e(socketFactory, "newSSLContext().apply {\n…ll)\n      }.socketFactory");
            return socketFactory;
        } catch (GeneralSecurityException e) {
            throw new AssertionError(dx1.k(e, "No System TLS: "), e);
        }
    }
    ...
    public X509TrustManager platformTrustManager() {
        ...
        throw new IllegalStateException(dx1.k(arrays, "Unexpected default trust managers: ").toString());
    }
    ...
    public X509TrustManager trustManager(SSLSocketFactory sSLSocketFactory) {
        ...
        try {
            ...
            if (dx1.a(e.getClass().getName(), "java.lang.reflect.InaccessibleObjectException")) {
                return null;
            }
            throw e;
        }
