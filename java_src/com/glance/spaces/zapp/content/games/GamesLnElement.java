...
public final class GamesLnElement extends GeneratedMessageV3 implements ag1 {
    ...
    private static final GamesLnElement DEFAULT_INSTANCE = new GamesLnElement();
    private static final Parser<GamesLnElement> PARSER = new a();

    /* loaded from: classes2.dex */
    public class a extends AbstractParser<GamesLnElement> {
        @Override // com.google.protobuf.Parser
        public GamesLnElement parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = GamesLnElement.newBuilder();
            try {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements ag1 {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return i.internal_static_com_glance_spaces_zapp_content_games_GamesLnElement_descriptor;
        }
        ...
        public b clearGameName() {
            this.gameName_ = GamesLnElement.getDefaultInstance().getGameName();
            onChanged();
            return this;
        }
        ...
        @Override // com.zapp.oneweatherzapp.ag1
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return i.internal_static_com_glance_spaces_zapp_content_games_GamesLnElement_fieldAccessorTable.ensureFieldAccessorsInitialized(GamesLnElement.class, b.class);
        }
        ...
        public GamesLnElement build() {
            GamesLnElement buildPartial = buildPartial();
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public GamesLnElement buildPartial() {
            GamesLnElement gamesLnElement = new GamesLnElement(this, 0);
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV3 = this.gameBannerBuilder_;
            if (singleFieldBuilderV3 == null) {
                gamesLnElement.gameBanner_ = this.gameBanner_;
            } else {
                gamesLnElement.gameBanner_ = singleFieldBuilderV3.build();
            }
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV32 = this.titleBuilder_;
            if (singleFieldBuilderV32 == null) {
                gamesLnElement.title_ = this.title_;
            } else {
                gamesLnElement.title_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<Tag, Tag.b, dp4> singleFieldBuilderV33 = this.tagBuilder_;
            if (singleFieldBuilderV33 == null) {
                gamesLnElement.tag_ = this.tag_;
            } else {
                gamesLnElement.tag_ = singleFieldBuilderV33.build();
            }
            gamesLnElement.gameName_ = this.gameName_;
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV34 = this.subtitleBuilder_;
            if (singleFieldBuilderV34 == null) {
                gamesLnElement.subtitle_ = this.subtitle_;
            } else {
                gamesLnElement.subtitle_ = singleFieldBuilderV34.build();
            }
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV35 = this.gamingLogoBuilder_;
            if (singleFieldBuilderV35 == null) {
                gamesLnElement.gamingLogo_ = this.gamingLogo_;
            } else {
                gamesLnElement.gamingLogo_ = singleFieldBuilderV35.build();
            }
            onBuilt();
            return gamesLnElement;
        }
        ...
        public GamesLnElement getDefaultInstanceForType() {
        ...
        public b mergeFrom(Message message) {
            if (message instanceof GamesLnElement) {
                return mergeFrom((GamesLnElement) message);
            }
            super.mergeFrom(message);
            return this;
        }

        public b mergeFrom(GamesLnElement gamesLnElement) {
            if (gamesLnElement == GamesLnElement.getDefaultInstance()) {
                return this;
            }
            if (gamesLnElement.hasGameBanner()) {
                mergeGameBanner(gamesLnElement.getGameBanner());
            }
            if (gamesLnElement.hasTitle()) {
                mergeTitle(gamesLnElement.getTitle());
            }
            if (gamesLnElement.hasTag()) {
                mergeTag(gamesLnElement.getTag());
            }
            if (!gamesLnElement.getGameName().isEmpty()) {
                this.gameName_ = gamesLnElement.gameName_;
                onChanged();
            }
            if (gamesLnElement.hasSubtitle()) {
                mergeSubtitle(gamesLnElement.getSubtitle());
            }
            if (gamesLnElement.hasGamingLogo()) {
                mergeGamingLogo(gamesLnElement.getGamingLogo());
            }
            mergeUnknownFields(gamesLnElement.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ GamesLnElement(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static GamesLnElement getDefaultInstance() {
    ...
    public static GamesLnElement parseDelimitedFrom(InputStream inputStream) {
        return (GamesLnElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static GamesLnElement parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<GamesLnElement> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof GamesLnElement)) {
            return super.equals(obj);
        }
        GamesLnElement gamesLnElement = (GamesLnElement) obj;
        if (hasGameBanner() != gamesLnElement.hasGameBanner()) {
            return false;
        }
        if ((hasGameBanner() && !getGameBanner().equals(gamesLnElement.getGameBanner())) || hasTitle() != gamesLnElement.hasTitle()) {
            return false;
        }
        if ((hasTitle() && !getTitle().equals(gamesLnElement.getTitle())) || hasTag() != gamesLnElement.hasTag()) {
            return false;
        }
        if ((hasTag() && !getTag().equals(gamesLnElement.getTag())) || !getGameName().equals(gamesLnElement.getGameName()) || hasSubtitle() != gamesLnElement.hasSubtitle()) {
            return false;
        }
        if ((hasSubtitle() && !getSubtitle().equals(gamesLnElement.getSubtitle())) || hasGamingLogo() != gamesLnElement.hasGamingLogo()) {
            return false;
        }
        if ((!hasGamingLogo() || getGamingLogo().equals(gamesLnElement.getGamingLogo())) && getUnknownFields().equals(gamesLnElement.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public Parser<GamesLnElement> getParserForType() {
        return PARSER;
    }
    ...
    private GamesLnElement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(GamesLnElement gamesLnElement) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(gamesLnElement);
    }

    public static GamesLnElement parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static GamesLnElement parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (GamesLnElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static GamesLnElement parseFrom(ByteString byteString) {
    ...
    private GamesLnElement() {
        this.memoizedIsInitialized = (byte) -1;
        this.gameName_ = "";
    }

    public static GamesLnElement parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
    ...
    public static GamesLnElement parseFrom(byte[] bArr) {
    ...
    public static GamesLnElement parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static GamesLnElement parseFrom(InputStream inputStream) {
        return (GamesLnElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static GamesLnElement parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (GamesLnElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static GamesLnElement parseFrom(CodedInputStream codedInputStream) {
        return (GamesLnElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static GamesLnElement parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (GamesLnElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
