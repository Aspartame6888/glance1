...
public class NetworkFetcher {
    ...
    private LottieResult<LottieComposition> fromJsonStream(String str, InputStream inputStream, String str2) {
        ...
        if (str2 != null && (networkCache = this.networkCache) != null) {
            String absolutePath = networkCache.writeTempCacheFile(str, inputStream, FileExtension.JSON).getAbsolutePath();
            FileInputStream fileInputStream = new FileInputStream(absolutePath);
            if (absolutePath != null) {
                file = new File(absolutePath);
            }
            return LottieCompositionFactory.fromJsonInputStreamSync(new h(h.b(file, fileInputStream)), str);
        }
    ...
    private LottieResult<LottieComposition> fromZipStream(Context context, String str, InputStream inputStream, String str2) {
        NetworkCache networkCache;
        if (str2 != null && (networkCache = this.networkCache) != null) {
            File writeTempCacheFile = networkCache.writeTempCacheFile(str, inputStream, FileExtension.ZIP);
            return LottieCompositionFactory.fromZipStreamSync(context, new ZipInputStream(h.a.a(new FileInputStream(writeTempCacheFile), writeTempCacheFile)), str);
        }
