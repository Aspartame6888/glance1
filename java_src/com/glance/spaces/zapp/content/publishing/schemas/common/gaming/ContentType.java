...
public enum ContentType implements ProtocolMessageEnum {
    ...
    private static final Internal.EnumLiteMap<ContentType> internalValueMap = new Internal.EnumLiteMap<ContentType>() { // from class: com.glance.spaces.zapp.content.publishing.schemas.common.gaming.ContentType.a
