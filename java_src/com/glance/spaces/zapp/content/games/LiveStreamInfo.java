...
public final class LiveStreamInfo extends GeneratedMessageV3 implements ef2 {
    ...
    private static final Parser<LiveStreamInfo> PARSER = new a();

    /* loaded from: classes2.dex */
    public class a extends AbstractParser<LiveStreamInfo> {
        @Override // com.google.protobuf.Parser
        public LiveStreamInfo parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = LiveStreamInfo.newBuilder();
            try {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements ef2 {
        ...
        private Tag liveTag_;
        private long startTime_;
        private SingleFieldBuilderV3<Image, Image.b, yr1> streamerAvatarBuilder_;
        private Image streamerAvatar_;
        private Object streamerName_;
        private SingleFieldBuilderV3<Image, Image.b, yr1> thumbnailBuilder_;
        private Image thumbnail_;
        private SingleFieldBuilderV3<Title, Title.b, tv4> titleBuilder_;
        private Title title_;
        private SingleFieldBuilderV3<Image, Image.b, yr1> viewCountIconBuilder_;
        private Image viewCountIcon_;
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return u.internal_static_com_glance_spaces_zapp_content_games_LiveStreamInfo_descriptor;
        }
        ...
        private SingleFieldBuilderV3<Image, Image.b, yr1> getStreamerAvatarFieldBuilder() {
        ...
        private SingleFieldBuilderV3<Image, Image.b, yr1> getThumbnailFieldBuilder() {
        ...
        private SingleFieldBuilderV3<Image, Image.b, yr1> getViewCountIconFieldBuilder() {
        ...
        public b clearGameName() {
            this.gameName_ = LiveStreamInfo.getDefaultInstance().getGameName();
            onChanged();
            return this;
        }
        ...
        public b clearStreamerName() {
            this.streamerName_ = LiveStreamInfo.getDefaultInstance().getStreamerName();
            onChanged();
            return this;
        }
        ...
        public b clearViewCountText() {
            this.viewCountText_ = LiveStreamInfo.getDefaultInstance().getViewCountText();
            onChanged();
            return this;
        }

        @Override // com.zapp.oneweatherzapp.ef2
        ...
        public Image getStreamerAvatar() {
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV3 = this.streamerAvatarBuilder_;
            if (singleFieldBuilderV3 == null) {
        ...
        @Override // com.zapp.oneweatherzapp.ef2
        public yr1 getStreamerAvatarOrBuilder() {
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV3 = this.streamerAvatarBuilder_;
            if (singleFieldBuilderV3 != null) {
                return singleFieldBuilderV3.getMessageOrBuilder();
            }
        ...
        public Image getThumbnail() {
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV3 = this.thumbnailBuilder_;
            if (singleFieldBuilderV3 == null) {
        ...
        @Override // com.zapp.oneweatherzapp.ef2
        public yr1 getThumbnailOrBuilder() {
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV3 = this.thumbnailBuilder_;
            if (singleFieldBuilderV3 != null) {
                return singleFieldBuilderV3.getMessageOrBuilder();
            }
        ...
        public Image getViewCountIcon() {
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV3 = this.viewCountIconBuilder_;
            if (singleFieldBuilderV3 == null) {
        ...
        @Override // com.zapp.oneweatherzapp.ef2
        public yr1 getViewCountIconOrBuilder() {
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV3 = this.viewCountIconBuilder_;
            if (singleFieldBuilderV3 != null) {
                return singleFieldBuilderV3.getMessageOrBuilder();
            }
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return u.internal_static_com_glance_spaces_zapp_content_games_LiveStreamInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(LiveStreamInfo.class, b.class);
        }
        ...
        public b mergeStreamerAvatar(Image image) {
            ...
            if (singleFieldBuilderV3 == null) {
                ...
                if (image2 != null) {
                    this.streamerAvatar_ = z00.a(image2, image);
                } else {
        ...
        public b mergeThumbnail(Image image) {
            ...
            if (singleFieldBuilderV3 == null) {
                ...
                if (image2 != null) {
                    this.thumbnail_ = z00.a(image2, image);
                } else {
        ...
        public b mergeViewCountIcon(Image image) {
            ...
            if (singleFieldBuilderV3 == null) {
                ...
                if (image2 != null) {
                    this.viewCountIcon_ = z00.a(image2, image);
                } else {
        ...
        public LiveStreamInfo build() {
            LiveStreamInfo buildPartial = buildPartial();
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public LiveStreamInfo buildPartial() {
            LiveStreamInfo liveStreamInfo = new LiveStreamInfo(this, 0);
            SingleFieldBuilderV3<Tag, Tag.b, dp4> singleFieldBuilderV3 = this.liveTagBuilder_;
            if (singleFieldBuilderV3 == null) {
                liveStreamInfo.liveTag_ = this.liveTag_;
            } else {
                liveStreamInfo.liveTag_ = singleFieldBuilderV3.build();
            }
            liveStreamInfo.viewCountText_ = this.viewCountText_;
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV32 = this.viewCountIconBuilder_;
            if (singleFieldBuilderV32 == null) {
                liveStreamInfo.viewCountIcon_ = this.viewCountIcon_;
            } else {
                liveStreamInfo.viewCountIcon_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV33 = this.thumbnailBuilder_;
            if (singleFieldBuilderV33 == null) {
                liveStreamInfo.thumbnail_ = this.thumbnail_;
            } else {
                liveStreamInfo.thumbnail_ = singleFieldBuilderV33.build();
            }
            SingleFieldBuilderV3<Deeplink, Deeplink.b, yf0> singleFieldBuilderV34 = this.deeplinkBuilder_;
            if (singleFieldBuilderV34 == null) {
                liveStreamInfo.deeplink_ = this.deeplink_;
            } else {
                liveStreamInfo.deeplink_ = singleFieldBuilderV34.build();
            }
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV35 = this.titleBuilder_;
            if (singleFieldBuilderV35 == null) {
                liveStreamInfo.title_ = this.title_;
            } else {
                liveStreamInfo.title_ = singleFieldBuilderV35.build();
            }
            liveStreamInfo.streamerName_ = this.streamerName_;
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV36 = this.streamerAvatarBuilder_;
            if (singleFieldBuilderV36 == null) {
                liveStreamInfo.streamerAvatar_ = this.streamerAvatar_;
            } else {
                liveStreamInfo.streamerAvatar_ = singleFieldBuilderV36.build();
            }
            liveStreamInfo.gameName_ = this.gameName_;
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV37 = this.gameIconBuilder_;
            if (singleFieldBuilderV37 == null) {
                liveStreamInfo.gameIcon_ = this.gameIcon_;
            } else {
                liveStreamInfo.gameIcon_ = singleFieldBuilderV37.build();
            }
            liveStreamInfo.startTime_ = this.startTime_;
            liveStreamInfo.endTime_ = this.endTime_;
            onBuilt();
        ...
        public LiveStreamInfo getDefaultInstanceForType() {
        ...
        public b mergeFrom(LiveStreamInfo liveStreamInfo) {
            if (liveStreamInfo == LiveStreamInfo.getDefaultInstance()) {
                return this;
            }
            if (liveStreamInfo.hasLiveTag()) {
                mergeLiveTag(liveStreamInfo.getLiveTag());
            }
            if (!liveStreamInfo.getViewCountText().isEmpty()) {
                this.viewCountText_ = liveStreamInfo.viewCountText_;
                onChanged();
            }
            if (liveStreamInfo.hasViewCountIcon()) {
                mergeViewCountIcon(liveStreamInfo.getViewCountIcon());
            }
            if (liveStreamInfo.hasThumbnail()) {
                mergeThumbnail(liveStreamInfo.getThumbnail());
            }
            if (liveStreamInfo.hasDeeplink()) {
                mergeDeeplink(liveStreamInfo.getDeeplink());
            }
            if (liveStreamInfo.hasTitle()) {
                mergeTitle(liveStreamInfo.getTitle());
            }
            if (!liveStreamInfo.getStreamerName().isEmpty()) {
                this.streamerName_ = liveStreamInfo.streamerName_;
                onChanged();
            }
            if (liveStreamInfo.hasStreamerAvatar()) {
                mergeStreamerAvatar(liveStreamInfo.getStreamerAvatar());
            }
            if (!liveStreamInfo.getGameName().isEmpty()) {
                this.gameName_ = liveStreamInfo.gameName_;
                onChanged();
            }
            if (liveStreamInfo.hasGameIcon()) {
                mergeGameIcon(liveStreamInfo.getGameIcon());
            }
            if (liveStreamInfo.getStartTime() != 0) {
                setStartTime(liveStreamInfo.getStartTime());
            }
            if (liveStreamInfo.getEndTime() != 0) {
                setEndTime(liveStreamInfo.getEndTime());
            }
            mergeUnknownFields(liveStreamInfo.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ LiveStreamInfo(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }
    ...
    public static LiveStreamInfo parseDelimitedFrom(InputStream inputStream) {
        return (LiveStreamInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static LiveStreamInfo parseFrom(ByteBuffer byteBuffer) {
    ...
    public boolean equals(Object obj) {
        ...
        if (hasLiveTag() != liveStreamInfo.hasLiveTag()) {
            return false;
        }
        if ((hasLiveTag() && !getLiveTag().equals(liveStreamInfo.getLiveTag())) || !getViewCountText().equals(liveStreamInfo.getViewCountText()) || hasViewCountIcon() != liveStreamInfo.hasViewCountIcon()) {
            return false;
        }
        if ((hasViewCountIcon() && !getViewCountIcon().equals(liveStreamInfo.getViewCountIcon())) || hasThumbnail() != liveStreamInfo.hasThumbnail()) {
            return false;
        }
        if ((hasThumbnail() && !getThumbnail().equals(liveStreamInfo.getThumbnail())) || hasDeeplink() != liveStreamInfo.hasDeeplink()) {
            return false;
        }
        if ((hasDeeplink() && !getDeeplink().equals(liveStreamInfo.getDeeplink())) || hasTitle() != liveStreamInfo.hasTitle()) {
            return false;
        }
        if ((hasTitle() && !getTitle().equals(liveStreamInfo.getTitle())) || !getStreamerName().equals(liveStreamInfo.getStreamerName()) || hasStreamerAvatar() != liveStreamInfo.hasStreamerAvatar()) {
            return false;
        }
        if ((hasStreamerAvatar() && !getStreamerAvatar().equals(liveStreamInfo.getStreamerAvatar())) || !getGameName().equals(liveStreamInfo.getGameName()) || hasGameIcon() != liveStreamInfo.hasGameIcon()) {
            return false;
        }
        if ((!hasGameIcon() || getGameIcon().equals(liveStreamInfo.getGameIcon())) && getStartTime() == liveStreamInfo.getStartTime() && getEndTime() == liveStreamInfo.getEndTime() && getUnknownFields().equals(liveStreamInfo.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public static b newBuilder(LiveStreamInfo liveStreamInfo) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(liveStreamInfo);
    }

    public static LiveStreamInfo parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static LiveStreamInfo parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (LiveStreamInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static LiveStreamInfo parseFrom(ByteString byteString) {
    ...
    public static LiveStreamInfo parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
    ...
    public static LiveStreamInfo parseFrom(byte[] bArr) {
    ...
    public static LiveStreamInfo parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static LiveStreamInfo parseFrom(InputStream inputStream) {
        return (LiveStreamInfo) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static LiveStreamInfo parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (LiveStreamInfo) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static LiveStreamInfo parseFrom(CodedInputStream codedInputStream) {
        return (LiveStreamInfo) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static LiveStreamInfo parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (LiveStreamInfo) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
