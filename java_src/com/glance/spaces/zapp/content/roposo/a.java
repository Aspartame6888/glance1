...
/* compiled from: EntertainmentLnElementOuterClass.java */
...
public final class a {
    ...
    static final Descriptors.Descriptor internal_static_com_glance_spaces_zapp_content_roposo_EntertainmentLnElement_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_com_glance_spaces_zapp_content_roposo_EntertainmentLnElement_fieldAccessorTable;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        internal_static_com_glance_spaces_zapp_content_roposo_EntertainmentLnElement_descriptor = descriptor2;
        internal_static_com_glance_spaces_zapp_content_roposo_EntertainmentLnElement_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Title", "Timestamp", "Subtitle", "Logo", "Tag", "Image"});
        j.getDescriptor();
        u.getDescriptor();
        v.getDescriptor();
        w.getDescriptor();
