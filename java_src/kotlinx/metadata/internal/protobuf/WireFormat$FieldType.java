...
public class WireFormat$FieldType {
    ...
    static {
        ...
        WireFormat$FieldType wireFormat$FieldType9 = new WireFormat$FieldType("STRING", 8, WireFormat$JavaType.STRING, 2) { // from class: kotlinx.metadata.internal.protobuf.WireFormat$FieldType.1
            @Override // kotlinx.metadata.internal.protobuf.WireFormat$FieldType
        ...
        WireFormat$FieldType wireFormat$FieldType10 = new WireFormat$FieldType("GROUP", 9, wireFormat$JavaType3, 3) { // from class: kotlinx.metadata.internal.protobuf.WireFormat$FieldType.2
            @Override // kotlinx.metadata.internal.protobuf.WireFormat$FieldType
            public boolean isPackable() {
                return false;
            }
        ...
        WireFormat$FieldType wireFormat$FieldType11 = new WireFormat$FieldType("MESSAGE", 10, wireFormat$JavaType3, 2) { // from class: kotlinx.metadata.internal.protobuf.WireFormat$FieldType.3
            @Override // kotlinx.metadata.internal.protobuf.WireFormat$FieldType
            public boolean isPackable() {
                return false;
            }
        ...
        WireFormat$FieldType wireFormat$FieldType12 = new WireFormat$FieldType("BYTES", 11, WireFormat$JavaType.BYTE_STRING, 2) { // from class: kotlinx.metadata.internal.protobuf.WireFormat$FieldType.4
            @Override // kotlinx.metadata.internal.protobuf.WireFormat$FieldType
            public boolean isPackable() {
                return false;
            }
