...
public final class m2 implements fn4 {
    ...
    public m2(Context context, CharSequence charSequence) {
        this.i = context;
        this.a = charSequence;
    }
    ...
    public final void c() {
        ...
        if (drawable != null) {
            if (this.n || this.o) {
                ...
                this.h = mutate;
                if (this.n) {
                    wr0.b.h(mutate, this.l);
                }
                if (this.o) {
                    wr0.b.i(this.h, this.m);
                }
            }
        }
    }
