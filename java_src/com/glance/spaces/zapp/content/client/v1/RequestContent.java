...
public final class RequestContent extends GeneratedMessageV3 implements wt3 {
    ...
    private static final RequestContent DEFAULT_INSTANCE = new RequestContent();
    private static final Parser<RequestContent> PARSER = new a();

    /* loaded from: classes2.dex */
    public class a extends AbstractParser<RequestContent> {
        @Override // com.google.protobuf.Parser
        public RequestContent parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = RequestContent.newBuilder();
            try {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements wt3 {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return com.glance.spaces.zapp.content.client.v1.a.internal_static_com_glance_spaces_zapp_content_client_v1_RequestContent_descriptor;
        }
        ...
        @Override // com.zapp.oneweatherzapp.wt3
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return com.glance.spaces.zapp.content.client.v1.a.internal_static_com_glance_spaces_zapp_content_client_v1_RequestContent_fieldAccessorTable.ensureFieldAccessorsInitialized(RequestContent.class, b.class);
        }
        ...
        public RequestContent build() {
            RequestContent buildPartial = buildPartial();
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public RequestContent buildPartial() {
            RequestContent requestContent = new RequestContent(this, 0);
            SingleFieldBuilderV3<TimeZone, TimeZone.b, ev4> singleFieldBuilderV3 = this.timeZoneBuilder_;
            if (singleFieldBuilderV3 == null) {
                requestContent.timeZone_ = this.timeZone_;
            } else {
                requestContent.timeZone_ = singleFieldBuilderV3.build();
            }
            RepeatedFieldBuilderV3<WidgetQuery, WidgetQuery.b, zg5> repeatedFieldBuilderV3 = this.widgetQueriesBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                requestContent.widgetQueries_ = repeatedFieldBuilderV3.build();
            } else {
                if ((this.bitField0_ & 1) != 0) {
                    this.widgetQueries_ = Collections.unmodifiableList(this.widgetQueries_);
                    this.bitField0_ &= -2;
                }
                requestContent.widgetQueries_ = this.widgetQueries_;
            }
            requestContent.lastUpdateInSecs_ = this.lastUpdateInSecs_;
            onBuilt();
        ...
        public RequestContent getDefaultInstanceForType() {
        ...
        public b mergeFrom(Message message) {
            if (message instanceof RequestContent) {
                return mergeFrom((RequestContent) message);
            }
        ...
        public b mergeFrom(RequestContent requestContent) {
            if (requestContent == RequestContent.getDefaultInstance()) {
                return this;
            }
            if (requestContent.hasTimeZone()) {
                mergeTimeZone(requestContent.getTimeZone());
            }
            if (this.widgetQueriesBuilder_ == null) {
                if (!requestContent.widgetQueries_.isEmpty()) {
                    if (this.widgetQueries_.isEmpty()) {
                        this.widgetQueries_ = requestContent.widgetQueries_;
                        this.bitField0_ &= -2;
                    } else {
                        ensureWidgetQueriesIsMutable();
                        this.widgetQueries_.addAll(requestContent.widgetQueries_);
                    }
                    onChanged();
                }
            } else if (!requestContent.widgetQueries_.isEmpty()) {
                if (!this.widgetQueriesBuilder_.isEmpty()) {
                    this.widgetQueriesBuilder_.addAllMessages(requestContent.widgetQueries_);
                } else {
            ...
            if (requestContent.getLastUpdateInSecs() != 0) {
                setLastUpdateInSecs(requestContent.getLastUpdateInSecs());
            }
            mergeUnknownFields(requestContent.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ RequestContent(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static RequestContent getDefaultInstance() {
    ...
    public static RequestContent parseDelimitedFrom(InputStream inputStream) {
        return (RequestContent) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static RequestContent parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<RequestContent> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (hasTimeZone() != requestContent.hasTimeZone()) {
            return false;
        }
        if ((!hasTimeZone() || getTimeZone().equals(requestContent.getTimeZone())) && getWidgetQueriesList().equals(requestContent.getWidgetQueriesList()) && getLastUpdateInSecs() == requestContent.getLastUpdateInSecs() && getUnknownFields().equals(requestContent.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public Parser<RequestContent> getParserForType() {
        return PARSER;
    }
    ...
    private RequestContent(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(RequestContent requestContent) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(requestContent);
    }

    public static RequestContent parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static RequestContent parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (RequestContent) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static RequestContent parseFrom(ByteString byteString) {
    ...
    public static RequestContent parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
    ...
    public static RequestContent parseFrom(byte[] bArr) {
    ...
    public static RequestContent parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static RequestContent parseFrom(InputStream inputStream) {
        return (RequestContent) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static RequestContent parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (RequestContent) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static RequestContent parseFrom(CodedInputStream codedInputStream) {
        return (RequestContent) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static RequestContent parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (RequestContent) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
