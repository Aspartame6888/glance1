...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    private static int extractHexDigit(String str, int i) {
        ...
        StringBuilder b = d3.b("Invalid hexString ", str, " must only contain [0-9a-fA-F] but contained ");
    ...
    public static ByteString fromHex(@CompileTimeConstant String str) {
        ...
        StringBuilder b = d3.b("Invalid hexString ", str, " of length ");
        b.append(str.length());
        b.append(" must be even.");
        throw new NumberFormatException(b.toString());
    }
    ...
    private String truncateAndEscapeForDisplay() {
        ...
        return p20.a(new StringBuilder(), TextFormatEscaper.escapeBytes(substring(0, 47)), "...");
    }
