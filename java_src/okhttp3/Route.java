...
public final class Route {
    ...
    public Route(Address address, Proxy proxy, InetSocketAddress inetSocketAddress) {
        ...
        dx1.f(proxy, "proxy");
        dx1.f(inetSocketAddress, "socketAddress");
    ...
    public final Address m474deprecated_address() {
        return this.address;
    }

    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m475deprecated_proxy() {
        return this.proxy;
    }

    /* renamed from: -deprecated_socketAddress  reason: not valid java name */
    public final InetSocketAddress m476deprecated_socketAddress() {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Route) {
            ...
            if (dx1.a(route.address, this.address) && dx1.a(route.proxy, this.proxy) && dx1.a(route.socketAddress, this.socketAddress)) {
                return true;
            }
        }
        return false;
