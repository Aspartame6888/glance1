...
/* compiled from: BreakingNewsElementOuterClass.java */
...
public final class a {
    ...
    static final Descriptors.Descriptor internal_static_com_glance_spaces_zapp_content_trendz_BreakingNewsElement_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_com_glance_spaces_zapp_content_trendz_BreakingNewsElement_fieldAccessorTable;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        internal_static_com_glance_spaces_zapp_content_trendz_BreakingNewsElement_descriptor = descriptor2;
        internal_static_com_glance_spaces_zapp_content_trendz_BreakingNewsElement_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Title", "Timestamp", "Logo", "Poster", "Tag", "TagsWithTtl"});
