...
public final class TaggedArticleLhElement extends GeneratedMessageV3 implements ep4 {
    ...
    private static final TaggedArticleLhElement DEFAULT_INSTANCE = new TaggedArticleLhElement();
    private static final Parser<TaggedArticleLhElement> PARSER = new a();

    /* loaded from: classes2.dex */
    public class a extends AbstractParser<TaggedArticleLhElement> {
        @Override // com.google.protobuf.Parser
        public TaggedArticleLhElement parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = TaggedArticleLhElement.newBuilder();
            try {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements ep4 {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return d.internal_static_com_glance_spaces_zapp_content_trendz_TaggedArticleLhElement_descriptor;
        }
        ...
        @Override // com.zapp.oneweatherzapp.ep4
        public Logo getLogo() {
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return d.internal_static_com_glance_spaces_zapp_content_trendz_TaggedArticleLhElement_fieldAccessorTable.ensureFieldAccessorsInitialized(TaggedArticleLhElement.class, b.class);
        }
        ...
        public TaggedArticleLhElement build() {
            TaggedArticleLhElement buildPartial = buildPartial();
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public TaggedArticleLhElement buildPartial() {
            TaggedArticleLhElement taggedArticleLhElement = new TaggedArticleLhElement(this, 0);
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV3 = this.titleBuilder_;
            if (singleFieldBuilderV3 == null) {
                taggedArticleLhElement.title_ = this.title_;
            } else {
                taggedArticleLhElement.title_ = singleFieldBuilderV3.build();
            }
            SingleFieldBuilderV3<Timestamp, Timestamp.b, lv4> singleFieldBuilderV32 = this.timestampBuilder_;
            if (singleFieldBuilderV32 == null) {
                taggedArticleLhElement.timestamp_ = this.timestamp_;
            } else {
                taggedArticleLhElement.timestamp_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<Logo, Logo.b, ci2> singleFieldBuilderV33 = this.logoBuilder_;
            if (singleFieldBuilderV33 == null) {
                taggedArticleLhElement.logo_ = this.logo_;
            } else {
                taggedArticleLhElement.logo_ = singleFieldBuilderV33.build();
            }
            SingleFieldBuilderV3<Poster, Poster.b, fh3> singleFieldBuilderV34 = this.posterBuilder_;
            if (singleFieldBuilderV34 == null) {
                taggedArticleLhElement.poster_ = this.poster_;
            } else {
                taggedArticleLhElement.poster_ = singleFieldBuilderV34.build();
            }
            SingleFieldBuilderV3<Tag, Tag.b, dp4> singleFieldBuilderV35 = this.tagBuilder_;
            if (singleFieldBuilderV35 == null) {
                taggedArticleLhElement.tag_ = this.tag_;
            } else {
                taggedArticleLhElement.tag_ = singleFieldBuilderV35.build();
            }
            RepeatedFieldBuilderV3<Tag, Tag.b, dp4> repeatedFieldBuilderV3 = this.tagsWithTtlBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                taggedArticleLhElement.tagsWithTtl_ = repeatedFieldBuilderV3.build();
            } else {
                if ((this.bitField0_ & 1) != 0) {
                    this.tagsWithTtl_ = Collections.unmodifiableList(this.tagsWithTtl_);
                    this.bitField0_ &= -2;
                }
                taggedArticleLhElement.tagsWithTtl_ = this.tagsWithTtl_;
            }
            onBuilt();
            return taggedArticleLhElement;
        }
        ...
        public TaggedArticleLhElement getDefaultInstanceForType() {
        ...
        public b mergeFrom(Message message) {
            if (message instanceof TaggedArticleLhElement) {
                return mergeFrom((TaggedArticleLhElement) message);
            }
        ...
        public b mergeFrom(TaggedArticleLhElement taggedArticleLhElement) {
            if (taggedArticleLhElement == TaggedArticleLhElement.getDefaultInstance()) {
                return this;
            }
            if (taggedArticleLhElement.hasTitle()) {
                mergeTitle(taggedArticleLhElement.getTitle());
            }
            if (taggedArticleLhElement.hasTimestamp()) {
                mergeTimestamp(taggedArticleLhElement.getTimestamp());
            }
            if (taggedArticleLhElement.hasLogo()) {
                mergeLogo(taggedArticleLhElement.getLogo());
            }
            if (taggedArticleLhElement.hasPoster()) {
                mergePoster(taggedArticleLhElement.getPoster());
            }
            if (taggedArticleLhElement.hasTag()) {
                mergeTag(taggedArticleLhElement.getTag());
            }
            if (this.tagsWithTtlBuilder_ == null) {
                if (!taggedArticleLhElement.tagsWithTtl_.isEmpty()) {
                    if (this.tagsWithTtl_.isEmpty()) {
                        this.tagsWithTtl_ = taggedArticleLhElement.tagsWithTtl_;
                        this.bitField0_ &= -2;
                    } else {
                        ensureTagsWithTtlIsMutable();
                        this.tagsWithTtl_.addAll(taggedArticleLhElement.tagsWithTtl_);
                    }
                    onChanged();
                }
            } else if (!taggedArticleLhElement.tagsWithTtl_.isEmpty()) {
                if (!this.tagsWithTtlBuilder_.isEmpty()) {
                    this.tagsWithTtlBuilder_.addAllMessages(taggedArticleLhElement.tagsWithTtl_);
                } else {
            ...
            mergeUnknownFields(taggedArticleLhElement.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ TaggedArticleLhElement(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static TaggedArticleLhElement getDefaultInstance() {
    ...
    public static TaggedArticleLhElement parseDelimitedFrom(InputStream inputStream) {
        return (TaggedArticleLhElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static TaggedArticleLhElement parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<TaggedArticleLhElement> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TaggedArticleLhElement)) {
            return super.equals(obj);
        }
        TaggedArticleLhElement taggedArticleLhElement = (TaggedArticleLhElement) obj;
        if (hasTitle() != taggedArticleLhElement.hasTitle()) {
            return false;
        }
        if ((hasTitle() && !getTitle().equals(taggedArticleLhElement.getTitle())) || hasTimestamp() != taggedArticleLhElement.hasTimestamp()) {
            return false;
        }
        if ((hasTimestamp() && !getTimestamp().equals(taggedArticleLhElement.getTimestamp())) || hasLogo() != taggedArticleLhElement.hasLogo()) {
            return false;
        }
        if ((hasLogo() && !getLogo().equals(taggedArticleLhElement.getLogo())) || hasPoster() != taggedArticleLhElement.hasPoster()) {
            return false;
        }
        if ((hasPoster() && !getPoster().equals(taggedArticleLhElement.getPoster())) || hasTag() != taggedArticleLhElement.hasTag()) {
            return false;
        }
        if ((!hasTag() || getTag().equals(taggedArticleLhElement.getTag())) && getTagsWithTtlList().equals(taggedArticleLhElement.getTagsWithTtlList()) && getUnknownFields().equals(taggedArticleLhElement.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public Parser<TaggedArticleLhElement> getParserForType() {
        return PARSER;
    }
    ...
    public Object newInstance(GeneratedMessageV3.UnusedPrivateParameter unusedPrivateParameter) {
        return new TaggedArticleLhElement();
    }
    ...
    private TaggedArticleLhElement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(TaggedArticleLhElement taggedArticleLhElement) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(taggedArticleLhElement);
    }

    public static TaggedArticleLhElement parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static TaggedArticleLhElement parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (TaggedArticleLhElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static TaggedArticleLhElement parseFrom(ByteString byteString) {
    ...
    private TaggedArticleLhElement() {
        this.memoizedIsInitialized = (byte) -1;
        this.tagsWithTtl_ = Collections.emptyList();
    }

    public static TaggedArticleLhElement parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
    ...
    public static TaggedArticleLhElement parseFrom(byte[] bArr) {
    ...
    public static TaggedArticleLhElement parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static TaggedArticleLhElement parseFrom(InputStream inputStream) {
        return (TaggedArticleLhElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static TaggedArticleLhElement parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (TaggedArticleLhElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static TaggedArticleLhElement parseFrom(CodedInputStream codedInputStream) {
        return (TaggedArticleLhElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static TaggedArticleLhElement parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (TaggedArticleLhElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
