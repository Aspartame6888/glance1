...
public final class Title extends GeneratedMessageV3 implements tv4 {
    private static final Title DEFAULT_INSTANCE = new Title();
    private static final Parser<Title> PARSER = new a();
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements tv4 {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return w.internal_static_com_glance_spaces_zapp_content_common_Title_descriptor;
        }
        ...
        @Override // com.zapp.oneweatherzapp.tv4
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return w.internal_static_com_glance_spaces_zapp_content_common_Title_fieldAccessorTable.ensureFieldAccessorsInitialized(Title.class, b.class);
        }
        ...
        public b mergeFrom(Title title) {
    ...
    public /* synthetic */ Title(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getText().equals(title.getText()) && getUnknownFields().equals(title.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public static b newBuilder(Title title) {
