...
class MapFieldSchemaFull implements MapFieldSchema {
    private static <K, V> int getSerializedSizeFull(int i, Object obj, Object obj2) {
        ...
        for (Map.Entry<K, V> entry : map.entrySet()) {
            i2 += CodedOutputStream.computeLengthDelimitedFieldSize(MapEntryLite.computeSerializedSize(mapEntry.getMetadata(), entry.getKey(), entry.getValue())) + CodedOutputStream.computeTagSize(i);
        }
        return i2;
    }
