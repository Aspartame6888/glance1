...
public final class nv0 extends InputConnectionWrapper {
    ...
    public static class a {
        ...
        */
        public static boolean a(android.view.inputmethod.InputConnection r7, android.text.Editable r8, int r9, int r10, boolean r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.zapp.oneweatherzapp.nv0.a.a(android.view.inputmethod.InputConnection, android.text.Editable, int, int, boolean):boolean");
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public nv0(EditText editText, InputConnection inputConnection, EditorInfo editorInfo) {
