...
import com.zapp.oneweatherzapp.i64;
import com.zapp.oneweatherzapp.k90;
import com.zapp.oneweatherzapp.np4;
import com.zapp.oneweatherzapp.o91;
...
public class SessionReportingCoordinator implements CrashlyticsLifecycleEvents {
    ...
    private ApplicationExitInfo findRelevantApplicationExitInfo(String str, List<ApplicationExitInfo> list) {
        ...
        for (ApplicationExitInfo applicationExitInfo : list) {
            ApplicationExitInfo a = o91.a(applicationExitInfo);
    ...
    private static List<CrashlyticsReport.CustomAttribute> getSortedCustomAttributes(Map<String, String> map) {
        ...
        Collections.sort(arrayList, new i64());
        return arrayList;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean onReportSendComplete(np4<CrashlyticsReportWithSessionId> np4Var) {
        if (np4Var.l()) {
            CrashlyticsReportWithSessionId i = np4Var.i();
            Logger logger = Logger.getLogger();
            logger.d("Crashlytics report successfully enqueued to DataTransport: " + i.getSessionId());
            File reportFile = i.getReportFile();
        ...
        Logger.getLogger().w("Crashlytics report could not be enqueued to DataTransport", np4Var.h());
        return false;
    }
    ...
    public np4<Void> sendReports(Executor executor) {
    ...
    public np4<Void> sendReports(Executor executor, String str) {
        ...
        for (CrashlyticsReportWithSessionId crashlyticsReportWithSessionId : loadFinalizedReports) {
            if (str == null || str.equals(crashlyticsReportWithSessionId.getSessionId())) {
                arrayList.add(this.reportsSender.enqueueReport(crashlyticsReportWithSessionId, str != null).e(executor, new k90() { // from class: com.zapp.oneweatherzapp.j64
                    @Override // com.zapp.oneweatherzapp.k90
                    public final Object then(np4 np4Var) {
                        boolean onReportSendComplete;
                        onReportSendComplete = SessionReportingCoordinator.this.onReportSendComplete(np4Var);
