...
public final class PublishFeaturedGameXlElement extends GeneratedMessageV3 implements com.glance.spaces.zapp.content.publishing.schemas.games.c {
    ...
    private static final PublishFeaturedGameXlElement DEFAULT_INSTANCE = new PublishFeaturedGameXlElement();
    private static final Parser<PublishFeaturedGameXlElement> PARSER = new a();
    ...
    public static final class TextInfo extends GeneratedMessageV3 implements c {
        ...
        public static final class b extends GeneratedMessageV3.Builder<b> implements c {
            ...
            public static final Descriptors.Descriptor getDescriptor() {
                return d.internal_static_com_glance_spaces_zapp_content_publishing_schemas_games_PublishFeaturedGameXlElement_TextInfo_descriptor;
            }
            ...
            @Override // com.glance.spaces.zapp.content.publishing.schemas.games.PublishFeaturedGameXlElement.c
            ...
            public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
                return d.internal_static_com_glance_spaces_zapp_content_publishing_schemas_games_PublishFeaturedGameXlElement_TextInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(TextInfo.class, b.class);
            }
    ...
    /* loaded from: classes2.dex */
    public class a extends AbstractParser<PublishFeaturedGameXlElement> {
        @Override // com.google.protobuf.Parser
        public PublishFeaturedGameXlElement parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = PublishFeaturedGameXlElement.newBuilder();
            try {
                newBuilder.mergeFrom(codedInputStream, extensionRegistryLite);
                return newBuilder.buildPartial();
            } catch (InvalidProtocolBufferException e) {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements com.glance.spaces.zapp.content.publishing.schemas.games.c {
        private int bitField0_;
        private RepeatedFieldBuilderV3<FeaturedGamesContent, FeaturedGamesContent.b, m21> contentBuilder_;
        private List<FeaturedGamesContent> content_;
        private RepeatedFieldBuilderV3<Poster, Poster.b, eh3> gameAssetsBuilder_;
        private List<Poster> gameAssets_;
        private SingleFieldBuilderV3<Poster, Poster.b, eh3> gameBannerBuilder_;
        private Poster gameBanner_;
        private Object gameName_;
        private SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> installCtaBuilder_;
        private ElementCta installCta_;
        private SingleFieldBuilderV3<TextInfo, TextInfo.b, c> textInfoBuilder_;
        private TextInfo textInfo_;
        private SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> viewMoreCtaBuilder_;
        private ElementCta viewMoreCta_;
        ...
        private RepeatedFieldBuilderV3<FeaturedGamesContent, FeaturedGamesContent.b, m21> getContentFieldBuilder() {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return d.internal_static_com_glance_spaces_zapp_content_publishing_schemas_games_PublishFeaturedGameXlElement_descriptor;
        }

        private RepeatedFieldBuilderV3<Poster, Poster.b, eh3> getGameAssetsFieldBuilder() {
            boolean z;
        ...
        private SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> getInstallCtaFieldBuilder() {
        ...
        private SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> getViewMoreCtaFieldBuilder() {
        ...
        public b addAllContent(Iterable<? extends FeaturedGamesContent> iterable) {
            RepeatedFieldBuilderV3<FeaturedGamesContent, FeaturedGamesContent.b, m21> repeatedFieldBuilderV3 = this.contentBuilder_;
        ...
        public b addAllGameAssets(Iterable<? extends Poster> iterable) {
            RepeatedFieldBuilderV3<Poster, Poster.b, eh3> repeatedFieldBuilderV3 = this.gameAssetsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
        ...
        public b clearGameName() {
            this.gameName_ = PublishFeaturedGameXlElement.getDefaultInstance().getGameName();
            onChanged();
            return this;
        }
        ...
        @Override // com.glance.spaces.zapp.content.publishing.schemas.games.c
        ...
        @Override // com.glance.spaces.zapp.content.publishing.schemas.games.c
        public m21 getContentOrBuilder(int i) {
            RepeatedFieldBuilderV3<FeaturedGamesContent, FeaturedGamesContent.b, m21> repeatedFieldBuilderV3 = this.contentBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                return this.content_.get(i);
            }
        ...
        @Override // com.glance.spaces.zapp.content.publishing.schemas.games.c
        public List<? extends m21> getContentOrBuilderList() {
            RepeatedFieldBuilderV3<FeaturedGamesContent, FeaturedGamesContent.b, m21> repeatedFieldBuilderV3 = this.contentBuilder_;
            if (repeatedFieldBuilderV3 != null) {
        ...
        @Override // com.glance.spaces.zapp.content.publishing.schemas.games.c
        public eh3 getGameAssetsOrBuilder(int i) {
            RepeatedFieldBuilderV3<Poster, Poster.b, eh3> repeatedFieldBuilderV3 = this.gameAssetsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                return this.gameAssets_.get(i);
            }
        ...
        @Override // com.glance.spaces.zapp.content.publishing.schemas.games.c
        public List<? extends eh3> getGameAssetsOrBuilderList() {
            RepeatedFieldBuilderV3<Poster, Poster.b, eh3> repeatedFieldBuilderV3 = this.gameAssetsBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                return repeatedFieldBuilderV3.getMessageOrBuilderList();
            }
        ...
        public ElementCta getInstallCta() {
            SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> singleFieldBuilderV3 = this.installCtaBuilder_;
            if (singleFieldBuilderV3 == null) {
        ...
        @Override // com.glance.spaces.zapp.content.publishing.schemas.games.c
        public xu0 getInstallCtaOrBuilder() {
            SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> singleFieldBuilderV3 = this.installCtaBuilder_;
            if (singleFieldBuilderV3 != null) {
                return singleFieldBuilderV3.getMessageOrBuilder();
            }
        ...
        public ElementCta getViewMoreCta() {
            SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> singleFieldBuilderV3 = this.viewMoreCtaBuilder_;
            if (singleFieldBuilderV3 == null) {
        ...
        @Override // com.glance.spaces.zapp.content.publishing.schemas.games.c
        public xu0 getViewMoreCtaOrBuilder() {
            SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> singleFieldBuilderV3 = this.viewMoreCtaBuilder_;
            if (singleFieldBuilderV3 != null) {
                return singleFieldBuilderV3.getMessageOrBuilder();
            }
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return d.internal_static_com_glance_spaces_zapp_content_publishing_schemas_games_PublishFeaturedGameXlElement_fieldAccessorTable.ensureFieldAccessorsInitialized(PublishFeaturedGameXlElement.class, b.class);
        }
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public PublishFeaturedGameXlElement build() {
            PublishFeaturedGameXlElement buildPartial = buildPartial();
            if (buildPartial.isInitialized()) {
                return buildPartial;
            }
            throw AbstractMessage.Builder.newUninitializedMessageException((Message) buildPartial);
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public PublishFeaturedGameXlElement buildPartial() {
            PublishFeaturedGameXlElement publishFeaturedGameXlElement = new PublishFeaturedGameXlElement(this, 0);
            publishFeaturedGameXlElement.gameName_ = this.gameName_;
            SingleFieldBuilderV3<Poster, Poster.b, eh3> singleFieldBuilderV3 = this.gameBannerBuilder_;
            if (singleFieldBuilderV3 == null) {
                publishFeaturedGameXlElement.gameBanner_ = this.gameBanner_;
            } else {
                publishFeaturedGameXlElement.gameBanner_ = singleFieldBuilderV3.build();
            }
            RepeatedFieldBuilderV3<FeaturedGamesContent, FeaturedGamesContent.b, m21> repeatedFieldBuilderV3 = this.contentBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                publishFeaturedGameXlElement.content_ = repeatedFieldBuilderV3.build();
            } else {
                if ((this.bitField0_ & 1) != 0) {
                    this.content_ = Collections.unmodifiableList(this.content_);
                    this.bitField0_ &= -2;
                }
                publishFeaturedGameXlElement.content_ = this.content_;
            }
            SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> singleFieldBuilderV32 = this.viewMoreCtaBuilder_;
            if (singleFieldBuilderV32 == null) {
                publishFeaturedGameXlElement.viewMoreCta_ = this.viewMoreCta_;
            } else {
                publishFeaturedGameXlElement.viewMoreCta_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<ElementCta, ElementCta.b, xu0> singleFieldBuilderV33 = this.installCtaBuilder_;
            if (singleFieldBuilderV33 == null) {
                publishFeaturedGameXlElement.installCta_ = this.installCta_;
            } else {
                publishFeaturedGameXlElement.installCta_ = singleFieldBuilderV33.build();
            }
            RepeatedFieldBuilderV3<Poster, Poster.b, eh3> repeatedFieldBuilderV32 = this.gameAssetsBuilder_;
            if (repeatedFieldBuilderV32 != null) {
                publishFeaturedGameXlElement.gameAssets_ = repeatedFieldBuilderV32.build();
            } else {
                if ((this.bitField0_ & 2) != 0) {
                    this.gameAssets_ = Collections.unmodifiableList(this.gameAssets_);
                    this.bitField0_ &= -3;
                }
                publishFeaturedGameXlElement.gameAssets_ = this.gameAssets_;
            }
            SingleFieldBuilderV3<TextInfo, TextInfo.b, c> singleFieldBuilderV34 = this.textInfoBuilder_;
            if (singleFieldBuilderV34 == null) {
                publishFeaturedGameXlElement.textInfo_ = this.textInfo_;
            } else {
                publishFeaturedGameXlElement.textInfo_ = singleFieldBuilderV34.build();
            }
            onBuilt();
            return publishFeaturedGameXlElement;
        }
        ...
        @Override // com.google.protobuf.MessageLiteOrBuilder, com.google.protobuf.MessageOrBuilder
        public PublishFeaturedGameXlElement getDefaultInstanceForType() {
        ...
        @Override // com.google.protobuf.AbstractMessage.Builder, com.google.protobuf.Message.Builder
        public b mergeFrom(Message message) {
            if (message instanceof PublishFeaturedGameXlElement) {
                return mergeFrom((PublishFeaturedGameXlElement) message);
            }
            super.mergeFrom(message);
            return this;
        }
        ...
        public b mergeFrom(PublishFeaturedGameXlElement publishFeaturedGameXlElement) {
            if (publishFeaturedGameXlElement == PublishFeaturedGameXlElement.getDefaultInstance()) {
                return this;
            }
            if (!publishFeaturedGameXlElement.getGameName().isEmpty()) {
                this.gameName_ = publishFeaturedGameXlElement.gameName_;
                onChanged();
            }
            if (publishFeaturedGameXlElement.hasGameBanner()) {
                mergeGameBanner(publishFeaturedGameXlElement.getGameBanner());
            }
            if (this.contentBuilder_ == null) {
                if (!publishFeaturedGameXlElement.content_.isEmpty()) {
                    if (this.content_.isEmpty()) {
                        this.content_ = publishFeaturedGameXlElement.content_;
                        this.bitField0_ &= -2;
                    } else {
                        ensureContentIsMutable();
                        this.content_.addAll(publishFeaturedGameXlElement.content_);
                    }
                    onChanged();
                }
            } else if (!publishFeaturedGameXlElement.content_.isEmpty()) {
                if (!this.contentBuilder_.isEmpty()) {
                    this.contentBuilder_.addAllMessages(publishFeaturedGameXlElement.content_);
                } else {
            ...
            if (publishFeaturedGameXlElement.hasViewMoreCta()) {
                mergeViewMoreCta(publishFeaturedGameXlElement.getViewMoreCta());
            }
            if (publishFeaturedGameXlElement.hasInstallCta()) {
                mergeInstallCta(publishFeaturedGameXlElement.getInstallCta());
            }
            if (this.gameAssetsBuilder_ == null) {
                if (!publishFeaturedGameXlElement.gameAssets_.isEmpty()) {
                    if (this.gameAssets_.isEmpty()) {
                        this.gameAssets_ = publishFeaturedGameXlElement.gameAssets_;
                        this.bitField0_ &= -3;
                    } else {
                        ensureGameAssetsIsMutable();
                        this.gameAssets_.addAll(publishFeaturedGameXlElement.gameAssets_);
                    }
                    onChanged();
                }
            } else if (!publishFeaturedGameXlElement.gameAssets_.isEmpty()) {
                if (!this.gameAssetsBuilder_.isEmpty()) {
                    this.gameAssetsBuilder_.addAllMessages(publishFeaturedGameXlElement.gameAssets_);
                } else {
            ...
            if (publishFeaturedGameXlElement.hasTextInfo()) {
                mergeTextInfo(publishFeaturedGameXlElement.getTextInfo());
            }
            mergeUnknownFields(publishFeaturedGameXlElement.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ PublishFeaturedGameXlElement(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static PublishFeaturedGameXlElement getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
    ...
    public static PublishFeaturedGameXlElement parseDelimitedFrom(InputStream inputStream) {
        return (PublishFeaturedGameXlElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static PublishFeaturedGameXlElement parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<PublishFeaturedGameXlElement> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PublishFeaturedGameXlElement)) {
            return super.equals(obj);
        }
        PublishFeaturedGameXlElement publishFeaturedGameXlElement = (PublishFeaturedGameXlElement) obj;
        if (!getGameName().equals(publishFeaturedGameXlElement.getGameName()) || hasGameBanner() != publishFeaturedGameXlElement.hasGameBanner()) {
            return false;
        }
        if ((hasGameBanner() && !getGameBanner().equals(publishFeaturedGameXlElement.getGameBanner())) || !getContentList().equals(publishFeaturedGameXlElement.getContentList()) || hasViewMoreCta() != publishFeaturedGameXlElement.hasViewMoreCta()) {
            return false;
        }
        if ((hasViewMoreCta() && !getViewMoreCta().equals(publishFeaturedGameXlElement.getViewMoreCta())) || hasInstallCta() != publishFeaturedGameXlElement.hasInstallCta()) {
            return false;
        }
        if ((hasInstallCta() && !getInstallCta().equals(publishFeaturedGameXlElement.getInstallCta())) || !getGameAssetsList().equals(publishFeaturedGameXlElement.getGameAssetsList()) || hasTextInfo() != publishFeaturedGameXlElement.hasTextInfo()) {
            return false;
        }
        if ((!hasTextInfo() || getTextInfo().equals(publishFeaturedGameXlElement.getTextInfo())) && getUnknownFields().equals(publishFeaturedGameXlElement.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.MessageLite, com.google.protobuf.Message
    public Parser<PublishFeaturedGameXlElement> getParserForType() {
        return PARSER;
    }
    ...
    @Override // com.google.protobuf.GeneratedMessageV3
    public Object newInstance(GeneratedMessageV3.UnusedPrivateParameter unusedPrivateParameter) {
        return new PublishFeaturedGameXlElement();
    }
    ...
    private PublishFeaturedGameXlElement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(PublishFeaturedGameXlElement publishFeaturedGameXlElement) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(publishFeaturedGameXlElement);
    }

    public static PublishFeaturedGameXlElement parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static PublishFeaturedGameXlElement parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (PublishFeaturedGameXlElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static PublishFeaturedGameXlElement parseFrom(ByteString byteString) {
        return PARSER.parseFrom(byteString);
    }
    ...
    private PublishFeaturedGameXlElement() {
        this.memoizedIsInitialized = (byte) -1;
        this.gameName_ = "";
        this.content_ = Collections.emptyList();
        this.gameAssets_ = Collections.emptyList();
    ...
    public static PublishFeaturedGameXlElement parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteString, extensionRegistryLite);
    }
    ...
    public static PublishFeaturedGameXlElement parseFrom(byte[] bArr) {
        return PARSER.parseFrom(bArr);
    }
    ...
    public static PublishFeaturedGameXlElement parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static PublishFeaturedGameXlElement parseFrom(InputStream inputStream) {
        return (PublishFeaturedGameXlElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static PublishFeaturedGameXlElement parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (PublishFeaturedGameXlElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static PublishFeaturedGameXlElement parseFrom(CodedInputStream codedInputStream) {
        return (PublishFeaturedGameXlElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static PublishFeaturedGameXlElement parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (PublishFeaturedGameXlElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
