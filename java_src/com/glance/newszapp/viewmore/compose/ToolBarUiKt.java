...
public final class ToolBarUiKt {
    public static final void a(final qz2 qz2Var, Composer composer, final int i) {
        ...
        if ((i2 & 11) == 2 && i4.j()) {
            ...
            f = l.f(aVar, 1.0f);
            b = androidx.compose.foundation.a.b(l.h(f, 40), oz.b, wq3.a);
            ...
            if (oeVar instanceof oe) {
                ...
                Painter a3 = ga3.a(R.drawable.arrow_back_2, i4);
                String l = et0.l(R.string.go_back, i4);
                Modifier i5 = PaddingKt.i(androidx.compose.foundation.c.c(aVar, new ce1<k55>() { // from class: com.glance.newszapp.viewmore.compose.ToolBarUiKt$ToolBar$1$1
                    {
                        super(0);
                    }
                    ...
                    public final void invoke2() {
                        qz2.this.a().setValue(new v45.a(lx.a.a));
                    }
                }), 12, 0.0f, 24, 0.0f, 10);
                long j = oz.f;
                IconKt.a(a3, l, i5, j, i4, 3080, 0);
        ...
        sq3 Z = i4.Z();
        if (Z != null) {
            Z.d = new Function2<Composer, Integer, k55>() { // from class: com.glance.newszapp.viewmore.compose.ToolBarUiKt$ToolBar$2
                ...
                public final void invoke(Composer composer2, int i6) {
                    ToolBarUiKt.a(qz2.this, composer2, m70.p(i | 1));
                }
            };
        }
    }
