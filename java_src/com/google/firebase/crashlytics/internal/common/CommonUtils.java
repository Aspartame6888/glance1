...
public class CommonUtils {
    ...
    public static String createInstanceIdFrom(String... strArr) {
        ...
        for (String str : strArr) {
            if (str != null) {
                arrayList.add(str.replace(AppConstants.SPLITTER, "").toLowerCase(Locale.US));
            }
        }
    ...
    */
    public static java.lang.String extractFieldFromSystemFile(java.io.File r6, java.lang.String r7) {
        /*
            ...
            io.sentry.instrumentation.file.l r3 = new io.sentry.instrumentation.file.l     // Catch: java.lang.Throwable -> L3c java.lang.Exception -> L3e
