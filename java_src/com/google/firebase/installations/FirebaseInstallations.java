...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    private np4<InstallationTokenResult> addGetAuthTokenListener() {
        rp4 rp4Var = new rp4();
        addStateListeners(new GetAuthTokenListener(this.utils, rp4Var));
        return rp4Var.a;
    }

    private np4<String> addGetIdListener() {
        rp4 rp4Var = new rp4();
        addStateListeners(new GetIdListener(rp4Var));
        return rp4Var.a;
    }
    ...
    */
    ...
    public final void lambda$getToken$2(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.zapp.oneweatherzapp.e41
    ...
    private void preConditionChecks() {
        kh3.f(APP_ID_VALIDATION_MSG, getApplicationId());
        kh3.f(PROJECT_ID_VALIDATION_MSG, getProjectIdentifier());
        kh3.f(API_KEY_VALIDATION_MSG, getApiKey());
        kh3.a(APP_ID_VALIDATION_MSG, Utils.isValidAppIdFormat(getApplicationId()));
        kh3.a(API_KEY_VALIDATION_MSG, Utils.isValidApiKeyFormat(getApiKey()));
    }
    ...
    public np4<Void> delete() {
        return fq4.c(this.backgroundExecutor, new f41(this, 0));
    }
    ...
    @Override // com.google.firebase.installations.FirebaseInstallationsApi
    public np4<String> getId() {
        preConditionChecks();
        String cacheFid = getCacheFid();
        if (cacheFid != null) {
            return fq4.e(cacheFid);
        }
        np4<String> addGetIdListener = addGetIdListener();
        this.backgroundExecutor.execute(new Runnable() { // from class: com.zapp.oneweatherzapp.h41
            @Override // java.lang.Runnable
            public final void run() {
    ...
    @Override // com.google.firebase.installations.FirebaseInstallationsApi
    public np4<InstallationTokenResult> getToken(final boolean z) {
        preConditionChecks();
        np4<InstallationTokenResult> addGetAuthTokenListener = addGetAuthTokenListener();
        this.backgroundExecutor.execute(new Runnable() { // from class: com.zapp.oneweatherzapp.g41
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static FirebaseInstallations getInstance(FirebaseApp firebaseApp) {
        kh3.a("Null is not a valid value of FirebaseApp.", firebaseApp != null);
