...
public enum SeasonPhase implements ProtocolMessageEnum {
    ...
    private static final Internal.EnumLiteMap<SeasonPhase> internalValueMap = new Internal.EnumLiteMap<SeasonPhase>() { // from class: com.glance.spaces.zapp.content.sports.SeasonPhase.a
