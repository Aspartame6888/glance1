...
public final class NbaMatchElement extends GeneratedMessageV3 implements g {
    ...
    private static final NbaMatchElement DEFAULT_INSTANCE = new NbaMatchElement();
    private static final Parser<NbaMatchElement> PARSER = new a();
    ...
    public static final class Team extends GeneratedMessageV3 implements c {
        ...
        public static final class b extends GeneratedMessageV3.Builder<b> implements c {
            ...
            public static final Descriptors.Descriptor getDescriptor() {
                return h.internal_static_com_glance_spaces_zapp_content_sports_NbaMatchElement_Team_descriptor;
            }
            ...
            @Override // com.glance.spaces.zapp.content.sports.NbaMatchElement.c
            public Logo getLogo() {
            ...
            public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
                return h.internal_static_com_glance_spaces_zapp_content_sports_NbaMatchElement_Team_fieldAccessorTable.ensureFieldAccessorsInitialized(Team.class, b.class);
            }
    ...
    /* loaded from: classes2.dex */
    public class a extends AbstractParser<NbaMatchElement> {
        @Override // com.google.protobuf.Parser
        public NbaMatchElement parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = NbaMatchElement.newBuilder();
            try {
                newBuilder.mergeFrom(codedInputStream, extensionRegistryLite);
                return newBuilder.buildPartial();
            } catch (InvalidProtocolBufferException e) {
    ...
    public static final class b extends GeneratedMessageV3.Builder<b> implements g {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return h.internal_static_com_glance_spaces_zapp_content_sports_NbaMatchElement_descriptor;
        }
        ...
        public b clearMatchId() {
            this.matchId_ = NbaMatchElement.getDefaultInstance().getMatchId();
            onChanged();
            return this;
        }
        ...
        public b clearMatchType() {
            this.matchType_ = NbaMatchElement.getDefaultInstance().getMatchType();
            onChanged();
            return this;
        }
        ...
        public b clearVenue() {
            this.venue_ = NbaMatchElement.getDefaultInstance().getVenue();
            onChanged();
            return this;
        }
        ...
        @Override // com.glance.spaces.zapp.content.sports.g
        public Logo getLogo() {
            SingleFieldBuilderV3<Logo, Logo.b, ci2> singleFieldBuilderV3 = this.logoBuilder_;
            if (singleFieldBuilderV3 == null) {
                Logo logo = this.logo_;
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.Builder
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return h.internal_static_com_glance_spaces_zapp_content_sports_NbaMatchElement_fieldAccessorTable.ensureFieldAccessorsInitialized(NbaMatchElement.class, b.class);
        }
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public NbaMatchElement build() {
            NbaMatchElement buildPartial = buildPartial();
            if (buildPartial.isInitialized()) {
                return buildPartial;
            }
            throw AbstractMessage.Builder.newUninitializedMessageException((Message) buildPartial);
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public NbaMatchElement buildPartial() {
            NbaMatchElement nbaMatchElement = new NbaMatchElement(this, 0);
            SingleFieldBuilderV3<Team, Team.b, c> singleFieldBuilderV3 = this.team1Builder_;
            if (singleFieldBuilderV3 == null) {
                nbaMatchElement.team1_ = this.team1_;
            } else {
                nbaMatchElement.team1_ = singleFieldBuilderV3.build();
            }
            SingleFieldBuilderV3<Team, Team.b, c> singleFieldBuilderV32 = this.team2Builder_;
            if (singleFieldBuilderV32 == null) {
                nbaMatchElement.team2_ = this.team2_;
            } else {
                nbaMatchElement.team2_ = singleFieldBuilderV32.build();
            }
            nbaMatchElement.matchStartTime_ = this.matchStartTime_;
            nbaMatchElement.matchType_ = this.matchType_;
            nbaMatchElement.venue_ = this.venue_;
            SingleFieldBuilderV3<Logo, Logo.b, ci2> singleFieldBuilderV33 = this.logoBuilder_;
            if (singleFieldBuilderV33 == null) {
                nbaMatchElement.logo_ = this.logo_;
            } else {
                nbaMatchElement.logo_ = singleFieldBuilderV33.build();
            }
            nbaMatchElement.matchId_ = this.matchId_;
            onBuilt();
            return nbaMatchElement;
        }
        ...
        @Override // com.google.protobuf.MessageLiteOrBuilder, com.google.protobuf.MessageOrBuilder
        public NbaMatchElement getDefaultInstanceForType() {
        ...
        @Override // com.google.protobuf.AbstractMessage.Builder, com.google.protobuf.Message.Builder
        public b mergeFrom(Message message) {
            if (message instanceof NbaMatchElement) {
                return mergeFrom((NbaMatchElement) message);
            }
            super.mergeFrom(message);
            return this;
        }

        public b mergeFrom(NbaMatchElement nbaMatchElement) {
            if (nbaMatchElement == NbaMatchElement.getDefaultInstance()) {
                return this;
            }
            if (nbaMatchElement.hasTeam1()) {
                mergeTeam1(nbaMatchElement.getTeam1());
            }
            if (nbaMatchElement.hasTeam2()) {
                mergeTeam2(nbaMatchElement.getTeam2());
            }
            if (nbaMatchElement.getMatchStartTime() != 0) {
                setMatchStartTime(nbaMatchElement.getMatchStartTime());
            }
            if (!nbaMatchElement.getMatchType().isEmpty()) {
                this.matchType_ = nbaMatchElement.matchType_;
                onChanged();
            }
            if (!nbaMatchElement.getVenue().isEmpty()) {
                this.venue_ = nbaMatchElement.venue_;
                onChanged();
            }
            if (nbaMatchElement.hasLogo()) {
                mergeLogo(nbaMatchElement.getLogo());
            }
            if (!nbaMatchElement.getMatchId().isEmpty()) {
                this.matchId_ = nbaMatchElement.matchId_;
                onChanged();
            }
            mergeUnknownFields(nbaMatchElement.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ NbaMatchElement(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static NbaMatchElement getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
    ...
    public static NbaMatchElement parseDelimitedFrom(InputStream inputStream) {
        return (NbaMatchElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static NbaMatchElement parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<NbaMatchElement> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof NbaMatchElement)) {
            return super.equals(obj);
        }
        NbaMatchElement nbaMatchElement = (NbaMatchElement) obj;
        if (hasTeam1() != nbaMatchElement.hasTeam1()) {
            return false;
        }
        if ((hasTeam1() && !getTeam1().equals(nbaMatchElement.getTeam1())) || hasTeam2() != nbaMatchElement.hasTeam2()) {
            return false;
        }
        if ((hasTeam2() && !getTeam2().equals(nbaMatchElement.getTeam2())) || getMatchStartTime() != nbaMatchElement.getMatchStartTime() || !getMatchType().equals(nbaMatchElement.getMatchType()) || !getVenue().equals(nbaMatchElement.getVenue()) || hasLogo() != nbaMatchElement.hasLogo()) {
            return false;
        }
        if ((!hasLogo() || getLogo().equals(nbaMatchElement.getLogo())) && getMatchId().equals(nbaMatchElement.getMatchId()) && getUnknownFields().equals(nbaMatchElement.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.MessageLite, com.google.protobuf.Message
    public Parser<NbaMatchElement> getParserForType() {
        return PARSER;
    }
    ...
    private NbaMatchElement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(NbaMatchElement nbaMatchElement) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(nbaMatchElement);
    }

    public static NbaMatchElement parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static NbaMatchElement parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (NbaMatchElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static NbaMatchElement parseFrom(ByteString byteString) {
        return PARSER.parseFrom(byteString);
    }
    ...
    public static NbaMatchElement parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteString, extensionRegistryLite);
    }
    ...
    public static NbaMatchElement parseFrom(byte[] bArr) {
        return PARSER.parseFrom(bArr);
    }
    ...
    public static NbaMatchElement parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static NbaMatchElement parseFrom(InputStream inputStream) {
        return (NbaMatchElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static NbaMatchElement parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (NbaMatchElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static NbaMatchElement parseFrom(CodedInputStream codedInputStream) {
        return (NbaMatchElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static NbaMatchElement parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (NbaMatchElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
