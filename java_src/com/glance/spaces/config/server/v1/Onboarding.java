...
public final class Onboarding extends GeneratedMessageV3 implements u53 {
    ...
    /* loaded from: classes.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements u53 {
        private RepeatedFieldBuilderV3<AgeGroup, AgeGroup.b, h4> ageGroupsBuilder_;
        private List<AgeGroup> ageGroups_;
        ...
        private RepeatedFieldBuilderV3<AgeGroup, AgeGroup.b, h4> getAgeGroupsFieldBuilder() {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return com.glance.spaces.config.server.v1.a.internal_static_com_glance_spaces_config_server_v1_Onboarding_descriptor;
        }

        public b addAgeGroups(AgeGroup ageGroup) {
            RepeatedFieldBuilderV3<AgeGroup, AgeGroup.b, h4> repeatedFieldBuilderV3 = this.ageGroupsBuilder_;
        ...
        @Override // com.zapp.oneweatherzapp.u53
        ...
        @Override // com.zapp.oneweatherzapp.u53
        public h4 getAgeGroupsOrBuilder(int i) {
            RepeatedFieldBuilderV3<AgeGroup, AgeGroup.b, h4> repeatedFieldBuilderV3 = this.ageGroupsBuilder_;
            if (repeatedFieldBuilderV3 == null) {
                return this.ageGroups_.get(i);
            }
        ...
        @Override // com.zapp.oneweatherzapp.u53
        public List<? extends h4> getAgeGroupsOrBuilderList() {
            RepeatedFieldBuilderV3<AgeGroup, AgeGroup.b, h4> repeatedFieldBuilderV3 = this.ageGroupsBuilder_;
            if (repeatedFieldBuilderV3 != null) {
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return com.glance.spaces.config.server.v1.a.internal_static_com_glance_spaces_config_server_v1_Onboarding_fieldAccessorTable.ensureFieldAccessorsInitialized(Onboarding.class, b.class);
        }
