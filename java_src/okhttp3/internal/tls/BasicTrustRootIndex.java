...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public BasicTrustRootIndex(X509Certificate... x509CertificateArr) {
        dx1.f(x509CertificateArr, "caCerts");
        ...
        while (i < length) {
            ...
            dx1.e(subjectX500Principal, "caCert.subjectX500Principal");
    ...
    public boolean equals(Object obj) {
        if (obj != this && (!(obj instanceof BasicTrustRootIndex) || !dx1.a(((BasicTrustRootIndex) obj).subjectToCaCerts, this.subjectToCaCerts))) {
            return false;
        }
        return true;
    }
