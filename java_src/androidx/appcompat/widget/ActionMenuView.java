...
public class ActionMenuView extends LinearLayoutCompat implements f.b, k {
    ...
    public class d implements f.a {
        ...
        public final boolean a(f fVar, MenuItem menuItem) {
            ...
            if (z) {
                ...
                Toolbar.h hVar = toolbar.h0;
                if (hVar != null) {
                    z2 = uw4.this.b.onMenuItemSelected(0, menuItem);
                } else {
                    z2 = false;
                }
            }
    ...
    public Menu getMenu() {
        if (this.L == null) {
            ...
            aVar.e = aVar2;
            this.L.b(aVar, this.M);
            androidx.appcompat.widget.a aVar3 = this.P;
            aVar3.h = this;
            this.L = aVar3.c;
        }
        return this.L;
        ...
        if (this.S && childCount > 0) {
            ...
            while (true) {
                ...
                if (childAt.getVisibility() == 8) {
                    ...
                    if (z11 && ((ActionMenuItemView) childAt).e()) {
                        z6 = true;
                    } else {
                        z6 = false;
                    }
            ...
            if (z5) {
                ...
                while (i43 < i4) {
                    ...
                    if (!cVar6.f) {
                        ...
                        i7 = i39;
                        childAt4.measure(View.MeasureSpec.makeMeasureSpec((cVar6.b * i17) + cVar6.c, 1073741824), i7);
                    }
                    i43++;
                    i39 = i7;
                }
