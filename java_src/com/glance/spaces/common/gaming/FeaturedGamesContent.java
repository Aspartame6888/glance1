...
public final class FeaturedGamesContent extends GeneratedMessageV3 implements n21 {
    public static final int BANNER_ASSET_URL_FIELD_NUMBER = 4;
    public static final int CONTENT_COUNT_TEXT_FIELD_NUMBER = 15;
    public static final int CONTENT_TYPE_FIELD_NUMBER = 10;
    public static final int CTA_FIELD_NUMBER = 5;
    public static final int GIF_URL_FIELD_NUMBER = 14;
    ...
    private volatile Object contentCountText_;
    ...
    /* loaded from: classes.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements n21 {
        private SingleFieldBuilderV3<Poster, Poster.b, fh3> bannerAssetUrlBuilder_;
        private Poster bannerAssetUrl_;
        private Object contentCountText_;
        private int contentType_;
        private SingleFieldBuilderV3<ElementCta, ElementCta.b, yu0> ctaBuilder_;
        private ElementCta cta_;
        private Object gifUrl_;
        private long liveFrom_;
        private long liveTill_;
        private Object subtitle_;
        private SingleFieldBuilderV3<Poster, Poster.b, fh3> thumbnailBuilder_;
        private Poster thumbnail_;
        ...
        private long videoDuration_;
        private long videoViewCount_;
        private SingleFieldBuilderV3<Icon, Icon.b, fr1> viewCountLogoBuilder_;
        private Icon viewCountLogo_;
        ...
        private SingleFieldBuilderV3<Poster, Poster.b, fh3> getBannerAssetUrlFieldBuilder() {
        ...
        private SingleFieldBuilderV3<ElementCta, ElementCta.b, yu0> getCtaFieldBuilder() {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return com.glance.spaces.common.gaming.b.internal_static_com_glance_spaces_common_gaming_FeaturedGamesContent_descriptor;
        }

        private SingleFieldBuilderV3<Poster, Poster.b, fh3> getThumbnailFieldBuilder() {
        ...
        private SingleFieldBuilderV3<Icon, Icon.b, fr1> getViewCountLogoFieldBuilder() {
        ...
        public b clearContentCountText() {
            this.contentCountText_ = FeaturedGamesContent.getDefaultInstance().getContentCountText();
            onChanged();
            return this;
        }
        ...
        public b clearGifUrl() {
            this.gifUrl_ = FeaturedGamesContent.getDefaultInstance().getGifUrl();
            onChanged();
            return this;
        }
        ...
        @Override // com.zapp.oneweatherzapp.n21
        public Poster getBannerAssetUrl() {
            SingleFieldBuilderV3<Poster, Poster.b, fh3> singleFieldBuilderV3 = this.bannerAssetUrlBuilder_;
        ...
        @Override // com.zapp.oneweatherzapp.n21
        public fh3 getBannerAssetUrlOrBuilder() {
            SingleFieldBuilderV3<Poster, Poster.b, fh3> singleFieldBuilderV3 = this.bannerAssetUrlBuilder_;
            if (singleFieldBuilderV3 != null) {
        ...
        @Override // com.zapp.oneweatherzapp.n21
        public String getContentCountText() {
            Object obj = this.contentCountText_;
            if (!(obj instanceof String)) {
                String stringUtf8 = ((ByteString) obj).toStringUtf8();
                this.contentCountText_ = stringUtf8;
                return stringUtf8;
            }
            return (String) obj;
        }
        ...
        @Override // com.zapp.oneweatherzapp.n21
        public ByteString getContentCountTextBytes() {
            Object obj = this.contentCountText_;
            if (obj instanceof String) {
                ByteString copyFromUtf8 = ByteString.copyFromUtf8((String) obj);
                this.contentCountText_ = copyFromUtf8;
                return copyFromUtf8;
            }
        ...
        public ElementCta getCta() {
            SingleFieldBuilderV3<ElementCta, ElementCta.b, yu0> singleFieldBuilderV3 = this.ctaBuilder_;
            if (singleFieldBuilderV3 == null) {
        ...
        public Poster getThumbnail() {
            SingleFieldBuilderV3<Poster, Poster.b, fh3> singleFieldBuilderV3 = this.thumbnailBuilder_;
            if (singleFieldBuilderV3 == null) {
        ...
        @Override // com.zapp.oneweatherzapp.n21
        public fh3 getThumbnailOrBuilder() {
            SingleFieldBuilderV3<Poster, Poster.b, fh3> singleFieldBuilderV3 = this.thumbnailBuilder_;
            if (singleFieldBuilderV3 != null) {
                return singleFieldBuilderV3.getMessageOrBuilder();
            }
        ...
        public Icon getViewCountLogo() {
            SingleFieldBuilderV3<Icon, Icon.b, fr1> singleFieldBuilderV3 = this.viewCountLogoBuilder_;
            if (singleFieldBuilderV3 == null) {
        ...
        @Override // com.zapp.oneweatherzapp.n21
        public fr1 getViewCountLogoOrBuilder() {
            SingleFieldBuilderV3<Icon, Icon.b, fr1> singleFieldBuilderV3 = this.viewCountLogoBuilder_;
            if (singleFieldBuilderV3 != null) {
                return singleFieldBuilderV3.getMessageOrBuilder();
            }
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return com.glance.spaces.common.gaming.b.internal_static_com_glance_spaces_common_gaming_FeaturedGamesContent_fieldAccessorTable.ensureFieldAccessorsInitialized(FeaturedGamesContent.class, b.class);
        }
        ...
        public b setContentCountText(String str) {
            str.getClass();
            this.contentCountText_ = str;
            onChanged();
            return this;
        }

        public b setContentCountTextBytes(ByteString byteString) {
            byteString.getClass();
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
            this.contentCountText_ = byteString;
            onChanged();
            return this;
        }
        ...
        public FeaturedGamesContent buildPartial() {
            ...
            SingleFieldBuilderV3<Poster, Poster.b, fh3> singleFieldBuilderV32 = this.thumbnailBuilder_;
            if (singleFieldBuilderV32 == null) {
                featuredGamesContent.thumbnail_ = this.thumbnail_;
            } else {
                featuredGamesContent.thumbnail_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<Poster, Poster.b, fh3> singleFieldBuilderV33 = this.bannerAssetUrlBuilder_;
            ...
            SingleFieldBuilderV3<ElementCta, ElementCta.b, yu0> singleFieldBuilderV34 = this.ctaBuilder_;
            ...
            SingleFieldBuilderV3<Icon, Icon.b, fr1> singleFieldBuilderV35 = this.viewCountLogoBuilder_;
            ...
            featuredGamesContent.gifUrl_ = this.gifUrl_;
            featuredGamesContent.contentCountText_ = this.contentCountText_;
            onBuilt();
        ...
        public b mergeFrom(FeaturedGamesContent featuredGamesContent) {
            ...
            if (!featuredGamesContent.getGifUrl().isEmpty()) {
                this.gifUrl_ = featuredGamesContent.gifUrl_;
                onChanged();
            }
            if (!featuredGamesContent.getContentCountText().isEmpty()) {
                this.contentCountText_ = featuredGamesContent.contentCountText_;
                onChanged();
            }
                    ...
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case ENTERTAINMENT_BUZZ_TRENDS_XXL_V1_VALUE:
                                this.contentCountText_ = codedInputStream.readStringRequireUtf8();
                                continue;
                            default:
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasViewCountLogo() || getViewCountLogo().equals(featuredGamesContent.getViewCountLogo())) && getViewCountText().equals(featuredGamesContent.getViewCountText()) && getGifUrl().equals(featuredGamesContent.getGifUrl()) && getContentCountText().equals(featuredGamesContent.getContentCountText()) && getUnknownFields().equals(featuredGamesContent.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public int getSerializedSize() {
        ...
        if (!GeneratedMessageV3.isStringEmpty(this.gifUrl_)) {
            i2 += GeneratedMessageV3.computeStringSize(14, this.gifUrl_);
        }
        if (!GeneratedMessageV3.isStringEmpty(this.contentCountText_)) {
            i2 += GeneratedMessageV3.computeStringSize(15, this.contentCountText_);
        }
    ...
    public int hashCode() {
        ...
        int hashCode4 = getGifUrl().hashCode();
        int hashCode5 = getContentCountText().hashCode();
        int hashCode6 = getUnknownFields().hashCode() + ((hashCode5 + ((((hashCode4 + ((((getViewCountText().hashCode() + b3) * 37) + 14) * 53)) * 37) + 15) * 53)) * 29);
    ...
    public void writeTo(CodedOutputStream codedOutputStream) {
        ...
        if (!GeneratedMessageV3.isStringEmpty(this.gifUrl_)) {
            GeneratedMessageV3.writeString(codedOutputStream, 14, this.gifUrl_);
        }
        if (!GeneratedMessageV3.isStringEmpty(this.contentCountText_)) {
            GeneratedMessageV3.writeString(codedOutputStream, 15, this.contentCountText_);
        }
