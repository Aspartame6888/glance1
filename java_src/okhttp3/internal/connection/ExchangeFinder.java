    ...
    */
    ...
    public final ExchangeCodec find(OkHttpClient okHttpClient, RealInterceptorChain realInterceptorChain) {
        ...
        try {
            ...
            if (!dx1.a(realInterceptorChain.getRequest$okhttp().method(), "GET")) {
                z = true;
            } else {
                z = false;
            }
    ...
    public final boolean sameHostAndPort(HttpUrl httpUrl) {
        ...
        if (httpUrl.port() == url.port() && dx1.a(httpUrl.host(), url.host())) {
            return true;
        }
        return false;
    }
