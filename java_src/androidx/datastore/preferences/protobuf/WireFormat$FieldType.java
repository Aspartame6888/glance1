...
public class WireFormat$FieldType {
    ...
    static {
        ...
        WireFormat$FieldType wireFormat$FieldType11 = new WireFormat$FieldType("MESSAGE", 10, wireFormat$JavaType3, 2) { // from class: androidx.datastore.preferences.protobuf.WireFormat$FieldType.3
        };
        MESSAGE = wireFormat$FieldType11;
        WireFormat$FieldType wireFormat$FieldType12 = new WireFormat$FieldType("BYTES", 11, WireFormat$JavaType.BYTE_STRING, 2) { // from class: androidx.datastore.preferences.protobuf.WireFormat$FieldType.4
        };
