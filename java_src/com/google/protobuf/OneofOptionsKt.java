...
public final class OneofOptionsKt {
    ...
    public static final class Dsl {
        ...
        /* compiled from: OneofOptionsKt.kt */
        @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0001¨\u0006\u0007"}, d2 = {"Lcom/google/protobuf/OneofOptionsKt$Dsl$Companion;", "", "()V", "_create", "Lcom/google/protobuf/OneofOptionsKt$Dsl;", "builder", "Lcom/google/protobuf/DescriptorProtos$OneofOptions$Builder;", "protobuf-kotlin"}, k = 1, mv = {1, 6, 0}, xi = 48)
        /* loaded from: classes3.dex */
        ...
        /* compiled from: OneofOptionsKt.kt */
        @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, d2 = {"Lcom/google/protobuf/OneofOptionsKt$Dsl$UninterpretedOptionProxy;", "Lcom/google/protobuf/kotlin/DslProxy;", "()V", "protobuf-kotlin"}, k = 1, mv = {1, 6, 0}, xi = 48)
        /* loaded from: classes3.dex */
        ...
        public /* synthetic */ Dsl(DescriptorProtos.OneofOptions.Builder builder, di0 di0Var) {
            this(builder);
        }

        /* renamed from: -getRepeatedExtension  reason: not valid java name */
        public final /* synthetic */ ExtensionList m296getRepeatedExtension(ExtensionLite extensionLite) {
        ...
        public final /* synthetic */ DescriptorProtos.OneofOptions _build() {
            DescriptorProtos.OneofOptions build = this._builder.build();
        ...
        public final /* synthetic */ <E> void plusAssign(ExtensionList<E, DescriptorProtos.OneofOptions> extensionList, E e) {
            dx1.f(extensionList, "<this>");
        ...
        public final /* synthetic */ <T extends Comparable<? super T>> void set(ExtensionLite<DescriptorProtos.OneofOptions, T> extensionLite, T t) {
            dx1.f(extensionLite, "extension");
        ...
        public final /* synthetic */ <E> void plusAssign(ExtensionList<E, DescriptorProtos.OneofOptions> extensionList, Iterable<? extends E> iterable) {
            dx1.f(extensionList, "<this>");
            dx1.f(iterable, "values");
            addAll(extensionList, iterable);
        }

        public final /* synthetic */ void set(ExtensionLite<DescriptorProtos.OneofOptions, ByteString> extensionLite, ByteString byteString) {
            dx1.f(extensionLite, "extension");
            dx1.f(byteString, FirebaseAnalytics.Param.VALUE);
            setExtension(extensionLite, byteString);
        }

        public final /* synthetic */ <T extends MessageLite> void set(ExtensionLite<DescriptorProtos.OneofOptions, T> extensionLite, T t) {
            dx1.f(extensionLite, "extension");
            dx1.f(t, FirebaseAnalytics.Param.VALUE);
            setExtension(extensionLite, t);
        }
