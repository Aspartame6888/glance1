...
public final class RecentlyPlayedGamesLnElement extends GeneratedMessageV3 implements qq3 {
    ...
    private static final RecentlyPlayedGamesLnElement DEFAULT_INSTANCE = new RecentlyPlayedGamesLnElement();
    private static final Parser<RecentlyPlayedGamesLnElement> PARSER = new a();

    /* loaded from: classes2.dex */
    public class a extends AbstractParser<RecentlyPlayedGamesLnElement> {
        @Override // com.google.protobuf.Parser
        public RecentlyPlayedGamesLnElement parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = RecentlyPlayedGamesLnElement.newBuilder();
            try {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements qq3 {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return v.internal_static_com_glance_spaces_zapp_content_games_RecentlyPlayedGamesLnElement_descriptor;
        }
        ...
        public b clearGameName() {
            this.gameName_ = RecentlyPlayedGamesLnElement.getDefaultInstance().getGameName();
            onChanged();
            return this;
        }
        ...
        @Override // com.zapp.oneweatherzapp.qq3
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return v.internal_static_com_glance_spaces_zapp_content_games_RecentlyPlayedGamesLnElement_fieldAccessorTable.ensureFieldAccessorsInitialized(RecentlyPlayedGamesLnElement.class, b.class);
        }
        ...
        public RecentlyPlayedGamesLnElement build() {
            RecentlyPlayedGamesLnElement buildPartial = buildPartial();
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public RecentlyPlayedGamesLnElement buildPartial() {
            RecentlyPlayedGamesLnElement recentlyPlayedGamesLnElement = new RecentlyPlayedGamesLnElement(this, 0);
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV3 = this.bgImageBuilder_;
            if (singleFieldBuilderV3 == null) {
                recentlyPlayedGamesLnElement.bgImage_ = this.bgImage_;
            } else {
                recentlyPlayedGamesLnElement.bgImage_ = singleFieldBuilderV3.build();
            }
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV32 = this.gameBannerBuilder_;
            if (singleFieldBuilderV32 == null) {
                recentlyPlayedGamesLnElement.gameBanner_ = this.gameBanner_;
            } else {
                recentlyPlayedGamesLnElement.gameBanner_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV33 = this.titleBuilder_;
            if (singleFieldBuilderV33 == null) {
                recentlyPlayedGamesLnElement.title_ = this.title_;
            } else {
                recentlyPlayedGamesLnElement.title_ = singleFieldBuilderV33.build();
            }
            SingleFieldBuilderV3<Tag, Tag.b, dp4> singleFieldBuilderV34 = this.tagBuilder_;
            if (singleFieldBuilderV34 == null) {
                recentlyPlayedGamesLnElement.tag_ = this.tag_;
            } else {
                recentlyPlayedGamesLnElement.tag_ = singleFieldBuilderV34.build();
            }
            recentlyPlayedGamesLnElement.gameName_ = this.gameName_;
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV35 = this.subtitleBuilder_;
            if (singleFieldBuilderV35 == null) {
                recentlyPlayedGamesLnElement.subtitle_ = this.subtitle_;
            } else {
                recentlyPlayedGamesLnElement.subtitle_ = singleFieldBuilderV35.build();
            }
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV36 = this.gamingLogoBuilder_;
            if (singleFieldBuilderV36 == null) {
                recentlyPlayedGamesLnElement.gamingLogo_ = this.gamingLogo_;
            } else {
                recentlyPlayedGamesLnElement.gamingLogo_ = singleFieldBuilderV36.build();
            }
            onBuilt();
            return recentlyPlayedGamesLnElement;
        }
        ...
        public RecentlyPlayedGamesLnElement getDefaultInstanceForType() {
        ...
        public b mergeFrom(Message message) {
            if (message instanceof RecentlyPlayedGamesLnElement) {
                return mergeFrom((RecentlyPlayedGamesLnElement) message);
            }
            super.mergeFrom(message);
            return this;
        }

        public b mergeFrom(RecentlyPlayedGamesLnElement recentlyPlayedGamesLnElement) {
            if (recentlyPlayedGamesLnElement == RecentlyPlayedGamesLnElement.getDefaultInstance()) {
                return this;
            }
            if (recentlyPlayedGamesLnElement.hasBgImage()) {
                mergeBgImage(recentlyPlayedGamesLnElement.getBgImage());
            }
            if (recentlyPlayedGamesLnElement.hasGameBanner()) {
                mergeGameBanner(recentlyPlayedGamesLnElement.getGameBanner());
            }
            if (recentlyPlayedGamesLnElement.hasTitle()) {
                mergeTitle(recentlyPlayedGamesLnElement.getTitle());
            }
            if (recentlyPlayedGamesLnElement.hasTag()) {
                mergeTag(recentlyPlayedGamesLnElement.getTag());
            }
            if (!recentlyPlayedGamesLnElement.getGameName().isEmpty()) {
                this.gameName_ = recentlyPlayedGamesLnElement.gameName_;
                onChanged();
            }
            if (recentlyPlayedGamesLnElement.hasSubtitle()) {
                mergeSubtitle(recentlyPlayedGamesLnElement.getSubtitle());
            }
            if (recentlyPlayedGamesLnElement.hasGamingLogo()) {
                mergeGamingLogo(recentlyPlayedGamesLnElement.getGamingLogo());
            }
            mergeUnknownFields(recentlyPlayedGamesLnElement.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ RecentlyPlayedGamesLnElement(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static RecentlyPlayedGamesLnElement getDefaultInstance() {
    ...
    public static RecentlyPlayedGamesLnElement parseDelimitedFrom(InputStream inputStream) {
        return (RecentlyPlayedGamesLnElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static RecentlyPlayedGamesLnElement parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<RecentlyPlayedGamesLnElement> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RecentlyPlayedGamesLnElement)) {
            return super.equals(obj);
        }
        RecentlyPlayedGamesLnElement recentlyPlayedGamesLnElement = (RecentlyPlayedGamesLnElement) obj;
        if (hasBgImage() != recentlyPlayedGamesLnElement.hasBgImage()) {
            return false;
        }
        if ((hasBgImage() && !getBgImage().equals(recentlyPlayedGamesLnElement.getBgImage())) || hasGameBanner() != recentlyPlayedGamesLnElement.hasGameBanner()) {
            return false;
        }
        if ((hasGameBanner() && !getGameBanner().equals(recentlyPlayedGamesLnElement.getGameBanner())) || hasTitle() != recentlyPlayedGamesLnElement.hasTitle()) {
            return false;
        }
        if ((hasTitle() && !getTitle().equals(recentlyPlayedGamesLnElement.getTitle())) || hasTag() != recentlyPlayedGamesLnElement.hasTag()) {
            return false;
        }
        if ((hasTag() && !getTag().equals(recentlyPlayedGamesLnElement.getTag())) || !getGameName().equals(recentlyPlayedGamesLnElement.getGameName()) || hasSubtitle() != recentlyPlayedGamesLnElement.hasSubtitle()) {
            return false;
        }
        if ((hasSubtitle() && !getSubtitle().equals(recentlyPlayedGamesLnElement.getSubtitle())) || hasGamingLogo() != recentlyPlayedGamesLnElement.hasGamingLogo()) {
            return false;
        }
        if ((!hasGamingLogo() || getGamingLogo().equals(recentlyPlayedGamesLnElement.getGamingLogo())) && getUnknownFields().equals(recentlyPlayedGamesLnElement.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public Parser<RecentlyPlayedGamesLnElement> getParserForType() {
        return PARSER;
    }
    ...
    public Object newInstance(GeneratedMessageV3.UnusedPrivateParameter unusedPrivateParameter) {
        return new RecentlyPlayedGamesLnElement();
    }
    ...
    private RecentlyPlayedGamesLnElement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(RecentlyPlayedGamesLnElement recentlyPlayedGamesLnElement) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(recentlyPlayedGamesLnElement);
    }

    public static RecentlyPlayedGamesLnElement parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static RecentlyPlayedGamesLnElement parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (RecentlyPlayedGamesLnElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static RecentlyPlayedGamesLnElement parseFrom(ByteString byteString) {
    ...
    private RecentlyPlayedGamesLnElement() {
        this.memoizedIsInitialized = (byte) -1;
        this.gameName_ = "";
    }

    public static RecentlyPlayedGamesLnElement parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
    ...
    public static RecentlyPlayedGamesLnElement parseFrom(byte[] bArr) {
    ...
    public static RecentlyPlayedGamesLnElement parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static RecentlyPlayedGamesLnElement parseFrom(InputStream inputStream) {
        return (RecentlyPlayedGamesLnElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static RecentlyPlayedGamesLnElement parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (RecentlyPlayedGamesLnElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static RecentlyPlayedGamesLnElement parseFrom(CodedInputStream codedInputStream) {
        return (RecentlyPlayedGamesLnElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static RecentlyPlayedGamesLnElement parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (RecentlyPlayedGamesLnElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
