...
public final class TaggedArticleLnElement extends GeneratedMessageV3 implements gp4 {
    ...
    private static final TaggedArticleLnElement DEFAULT_INSTANCE = new TaggedArticleLnElement();
    private static final Parser<TaggedArticleLnElement> PARSER = new a();

    /* loaded from: classes2.dex */
    public class a extends AbstractParser<TaggedArticleLnElement> {
        @Override // com.google.protobuf.Parser
        public TaggedArticleLnElement parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = TaggedArticleLnElement.newBuilder();
            try {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements gp4 {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return e.internal_static_com_glance_spaces_zapp_content_trendz_TaggedArticleLnElement_descriptor;
        }
        ...
        @Override // com.zapp.oneweatherzapp.gp4
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return e.internal_static_com_glance_spaces_zapp_content_trendz_TaggedArticleLnElement_fieldAccessorTable.ensureFieldAccessorsInitialized(TaggedArticleLnElement.class, b.class);
        }
        ...
        public TaggedArticleLnElement build() {
            TaggedArticleLnElement buildPartial = buildPartial();
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public TaggedArticleLnElement buildPartial() {
            TaggedArticleLnElement taggedArticleLnElement = new TaggedArticleLnElement(this, 0);
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV3 = this.titleBuilder_;
            if (singleFieldBuilderV3 == null) {
                taggedArticleLnElement.title_ = this.title_;
            } else {
                taggedArticleLnElement.title_ = singleFieldBuilderV3.build();
            }
            SingleFieldBuilderV3<Timestamp, Timestamp.b, lv4> singleFieldBuilderV32 = this.timestampBuilder_;
            if (singleFieldBuilderV32 == null) {
                taggedArticleLnElement.timestamp_ = this.timestamp_;
            } else {
                taggedArticleLnElement.timestamp_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<Logo, Logo.b, ci2> singleFieldBuilderV33 = this.logoBuilder_;
            if (singleFieldBuilderV33 == null) {
                taggedArticleLnElement.logo_ = this.logo_;
            } else {
                taggedArticleLnElement.logo_ = singleFieldBuilderV33.build();
            }
            SingleFieldBuilderV3<Poster, Poster.b, fh3> singleFieldBuilderV34 = this.posterBuilder_;
            if (singleFieldBuilderV34 == null) {
                taggedArticleLnElement.poster_ = this.poster_;
            } else {
                taggedArticleLnElement.poster_ = singleFieldBuilderV34.build();
            }
            SingleFieldBuilderV3<Tag, Tag.b, dp4> singleFieldBuilderV35 = this.tagBuilder_;
            if (singleFieldBuilderV35 == null) {
                taggedArticleLnElement.tag_ = this.tag_;
            } else {
                taggedArticleLnElement.tag_ = singleFieldBuilderV35.build();
            }
            RepeatedFieldBuilderV3<Tag, Tag.b, dp4> repeatedFieldBuilderV3 = this.tagsWithTtlBuilder_;
            if (repeatedFieldBuilderV3 != null) {
                taggedArticleLnElement.tagsWithTtl_ = repeatedFieldBuilderV3.build();
            } else {
                if ((this.bitField0_ & 1) != 0) {
                    this.tagsWithTtl_ = Collections.unmodifiableList(this.tagsWithTtl_);
                    this.bitField0_ &= -2;
                }
                taggedArticleLnElement.tagsWithTtl_ = this.tagsWithTtl_;
            }
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV36 = this.bgImageBuilder_;
            if (singleFieldBuilderV36 == null) {
                taggedArticleLnElement.bgImage_ = this.bgImage_;
            } else {
                taggedArticleLnElement.bgImage_ = singleFieldBuilderV36.build();
            }
            onBuilt();
            return taggedArticleLnElement;
        }
        ...
        public TaggedArticleLnElement getDefaultInstanceForType() {
        ...
        public b mergeFrom(Message message) {
            if (message instanceof TaggedArticleLnElement) {
                return mergeFrom((TaggedArticleLnElement) message);
            }
        ...
        public b mergeFrom(TaggedArticleLnElement taggedArticleLnElement) {
            if (taggedArticleLnElement == TaggedArticleLnElement.getDefaultInstance()) {
                return this;
            }
            if (taggedArticleLnElement.hasTitle()) {
                mergeTitle(taggedArticleLnElement.getTitle());
            }
            if (taggedArticleLnElement.hasTimestamp()) {
                mergeTimestamp(taggedArticleLnElement.getTimestamp());
            }
            if (taggedArticleLnElement.hasLogo()) {
                mergeLogo(taggedArticleLnElement.getLogo());
            }
            if (taggedArticleLnElement.hasPoster()) {
                mergePoster(taggedArticleLnElement.getPoster());
            }
            if (taggedArticleLnElement.hasTag()) {
                mergeTag(taggedArticleLnElement.getTag());
            }
            if (this.tagsWithTtlBuilder_ == null) {
                if (!taggedArticleLnElement.tagsWithTtl_.isEmpty()) {
                    if (this.tagsWithTtl_.isEmpty()) {
                        this.tagsWithTtl_ = taggedArticleLnElement.tagsWithTtl_;
                        this.bitField0_ &= -2;
                    } else {
                        ensureTagsWithTtlIsMutable();
                        this.tagsWithTtl_.addAll(taggedArticleLnElement.tagsWithTtl_);
                    }
                    onChanged();
                }
            } else if (!taggedArticleLnElement.tagsWithTtl_.isEmpty()) {
                if (!this.tagsWithTtlBuilder_.isEmpty()) {
                    this.tagsWithTtlBuilder_.addAllMessages(taggedArticleLnElement.tagsWithTtl_);
                } else {
            ...
            if (taggedArticleLnElement.hasBgImage()) {
                mergeBgImage(taggedArticleLnElement.getBgImage());
            }
            mergeUnknownFields(taggedArticleLnElement.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ TaggedArticleLnElement(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static TaggedArticleLnElement getDefaultInstance() {
    ...
    public static TaggedArticleLnElement parseDelimitedFrom(InputStream inputStream) {
        return (TaggedArticleLnElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static TaggedArticleLnElement parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<TaggedArticleLnElement> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TaggedArticleLnElement)) {
            return super.equals(obj);
        }
        TaggedArticleLnElement taggedArticleLnElement = (TaggedArticleLnElement) obj;
        if (hasTitle() != taggedArticleLnElement.hasTitle()) {
            return false;
        }
        if ((hasTitle() && !getTitle().equals(taggedArticleLnElement.getTitle())) || hasTimestamp() != taggedArticleLnElement.hasTimestamp()) {
            return false;
        }
        if ((hasTimestamp() && !getTimestamp().equals(taggedArticleLnElement.getTimestamp())) || hasLogo() != taggedArticleLnElement.hasLogo()) {
            return false;
        }
        if ((hasLogo() && !getLogo().equals(taggedArticleLnElement.getLogo())) || hasPoster() != taggedArticleLnElement.hasPoster()) {
            return false;
        }
        if ((hasPoster() && !getPoster().equals(taggedArticleLnElement.getPoster())) || hasTag() != taggedArticleLnElement.hasTag()) {
            return false;
        }
        if ((hasTag() && !getTag().equals(taggedArticleLnElement.getTag())) || !getTagsWithTtlList().equals(taggedArticleLnElement.getTagsWithTtlList()) || hasBgImage() != taggedArticleLnElement.hasBgImage()) {
            return false;
        }
        if ((!hasBgImage() || getBgImage().equals(taggedArticleLnElement.getBgImage())) && getUnknownFields().equals(taggedArticleLnElement.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public Parser<TaggedArticleLnElement> getParserForType() {
        return PARSER;
    }
    ...
    public int getSerializedSize() {
        ...
        if (this.bgImage_ != null) {
            i += CodedOutputStream.computeMessageSize(7, getBgImage());
        }
    ...
    public int hashCode() {
        ...
        if (hasBgImage()) {
            hashCode = vg0.b(hashCode, 37, 7, 53) + getBgImage().hashCode();
        }
    ...
    public Object newInstance(GeneratedMessageV3.UnusedPrivateParameter unusedPrivateParameter) {
        return new TaggedArticleLnElement();
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) {
        ...
        if (this.bgImage_ != null) {
            codedOutputStream.writeMessage(7, getBgImage());
        }
        getUnknownFields().writeTo(codedOutputStream);
    }

    private TaggedArticleLnElement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(TaggedArticleLnElement taggedArticleLnElement) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(taggedArticleLnElement);
    }

    public static TaggedArticleLnElement parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static TaggedArticleLnElement parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (TaggedArticleLnElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static TaggedArticleLnElement parseFrom(ByteString byteString) {
    ...
    private TaggedArticleLnElement() {
        this.memoizedIsInitialized = (byte) -1;
        this.tagsWithTtl_ = Collections.emptyList();
    }

    public static TaggedArticleLnElement parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
    ...
    public static TaggedArticleLnElement parseFrom(byte[] bArr) {
    ...
    public static TaggedArticleLnElement parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static TaggedArticleLnElement parseFrom(InputStream inputStream) {
        return (TaggedArticleLnElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static TaggedArticleLnElement parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (TaggedArticleLnElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static TaggedArticleLnElement parseFrom(CodedInputStream codedInputStream) {
        return (TaggedArticleLnElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static TaggedArticleLnElement parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (TaggedArticleLnElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
