...
public final class PublishCategorisedLvXxlElement extends GeneratedMessageV3 implements gm3 {
    ...
    private static final PublishCategorisedLvXxlElement DEFAULT_INSTANCE = new PublishCategorisedLvXxlElement();
    private static final Parser<PublishCategorisedLvXxlElement> PARSER = new a();

    /* loaded from: classes2.dex */
    public class a extends AbstractParser<PublishCategorisedLvXxlElement> {
        @Override // com.google.protobuf.Parser
        public PublishCategorisedLvXxlElement parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = PublishCategorisedLvXxlElement.newBuilder();
            try {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements gm3 {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return com.glance.spaces.zapp.content.publishing.schemas.trendz.a.internal_static_com_glance_spaces_zapp_content_publishing_schemas_trendz_PublishCategorisedLvXxlElement_descriptor;
        }
        ...
        @Override // com.zapp.oneweatherzapp.gm3
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return com.glance.spaces.zapp.content.publishing.schemas.trendz.a.internal_static_com_glance_spaces_zapp_content_publishing_schemas_trendz_PublishCategorisedLvXxlElement_fieldAccessorTable.ensureFieldAccessorsInitialized(PublishCategorisedLvXxlElement.class, b.class);
        }
        ...
        public PublishCategorisedLvXxlElement build() {
            PublishCategorisedLvXxlElement buildPartial = buildPartial();
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public PublishCategorisedLvXxlElement buildPartial() {
            PublishCategorisedLvXxlElement publishCategorisedLvXxlElement = new PublishCategorisedLvXxlElement(this, 0);
            SingleFieldBuilderV3<Title, Title.b, sv4> singleFieldBuilderV3 = this.titleBuilder_;
            if (singleFieldBuilderV3 == null) {
                publishCategorisedLvXxlElement.title_ = this.title_;
            } else {
                publishCategorisedLvXxlElement.title_ = singleFieldBuilderV3.build();
            }
            SingleFieldBuilderV3<Timestamp, Timestamp.b, kv4> singleFieldBuilderV32 = this.timestampBuilder_;
            if (singleFieldBuilderV32 == null) {
                publishCategorisedLvXxlElement.timestamp_ = this.timestamp_;
            } else {
                publishCategorisedLvXxlElement.timestamp_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<Logo, Logo.b, bi2> singleFieldBuilderV33 = this.logoBuilder_;
            if (singleFieldBuilderV33 == null) {
                publishCategorisedLvXxlElement.logo_ = this.logo_;
            } else {
                publishCategorisedLvXxlElement.logo_ = singleFieldBuilderV33.build();
            }
            SingleFieldBuilderV3<Poster, Poster.b, eh3> singleFieldBuilderV34 = this.posterBuilder_;
            if (singleFieldBuilderV34 == null) {
                publishCategorisedLvXxlElement.poster_ = this.poster_;
            } else {
                publishCategorisedLvXxlElement.poster_ = singleFieldBuilderV34.build();
            }
            SingleFieldBuilderV3<Tag, Tag.b, cp4> singleFieldBuilderV35 = this.tagBuilder_;
            if (singleFieldBuilderV35 == null) {
                publishCategorisedLvXxlElement.tag_ = this.tag_;
            } else {
                publishCategorisedLvXxlElement.tag_ = singleFieldBuilderV35.build();
            }
            SingleFieldBuilderV3<Image, Image.b, xr1> singleFieldBuilderV36 = this.bannerBuilder_;
            if (singleFieldBuilderV36 == null) {
                publishCategorisedLvXxlElement.banner_ = this.banner_;
            } else {
                publishCategorisedLvXxlElement.banner_ = singleFieldBuilderV36.build();
            }
            onBuilt();
            return publishCategorisedLvXxlElement;
        }
        ...
        public PublishCategorisedLvXxlElement getDefaultInstanceForType() {
        ...
        public b mergeFrom(Message message) {
            if (message instanceof PublishCategorisedLvXxlElement) {
                return mergeFrom((PublishCategorisedLvXxlElement) message);
            }
            super.mergeFrom(message);
            return this;
        }

        public b mergeFrom(PublishCategorisedLvXxlElement publishCategorisedLvXxlElement) {
            if (publishCategorisedLvXxlElement == PublishCategorisedLvXxlElement.getDefaultInstance()) {
                return this;
            }
            if (publishCategorisedLvXxlElement.hasTitle()) {
                mergeTitle(publishCategorisedLvXxlElement.getTitle());
            }
            if (publishCategorisedLvXxlElement.hasTimestamp()) {
                mergeTimestamp(publishCategorisedLvXxlElement.getTimestamp());
            }
            if (publishCategorisedLvXxlElement.hasLogo()) {
                mergeLogo(publishCategorisedLvXxlElement.getLogo());
            }
            if (publishCategorisedLvXxlElement.hasPoster()) {
                mergePoster(publishCategorisedLvXxlElement.getPoster());
            }
            if (publishCategorisedLvXxlElement.hasTag()) {
                mergeTag(publishCategorisedLvXxlElement.getTag());
            }
            if (publishCategorisedLvXxlElement.hasBanner()) {
                mergeBanner(publishCategorisedLvXxlElement.getBanner());
            }
            mergeUnknownFields(publishCategorisedLvXxlElement.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ PublishCategorisedLvXxlElement(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static PublishCategorisedLvXxlElement getDefaultInstance() {
    ...
    public static PublishCategorisedLvXxlElement parseDelimitedFrom(InputStream inputStream) {
        return (PublishCategorisedLvXxlElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static PublishCategorisedLvXxlElement parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<PublishCategorisedLvXxlElement> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PublishCategorisedLvXxlElement)) {
            return super.equals(obj);
        }
        PublishCategorisedLvXxlElement publishCategorisedLvXxlElement = (PublishCategorisedLvXxlElement) obj;
        if (hasTitle() != publishCategorisedLvXxlElement.hasTitle()) {
            return false;
        }
        if ((hasTitle() && !getTitle().equals(publishCategorisedLvXxlElement.getTitle())) || hasTimestamp() != publishCategorisedLvXxlElement.hasTimestamp()) {
            return false;
        }
        if ((hasTimestamp() && !getTimestamp().equals(publishCategorisedLvXxlElement.getTimestamp())) || hasLogo() != publishCategorisedLvXxlElement.hasLogo()) {
            return false;
        }
        if ((hasLogo() && !getLogo().equals(publishCategorisedLvXxlElement.getLogo())) || hasPoster() != publishCategorisedLvXxlElement.hasPoster()) {
            return false;
        }
        if ((hasPoster() && !getPoster().equals(publishCategorisedLvXxlElement.getPoster())) || hasTag() != publishCategorisedLvXxlElement.hasTag()) {
            return false;
        }
        if ((hasTag() && !getTag().equals(publishCategorisedLvXxlElement.getTag())) || hasBanner() != publishCategorisedLvXxlElement.hasBanner()) {
            return false;
        }
        if ((!hasBanner() || getBanner().equals(publishCategorisedLvXxlElement.getBanner())) && getUnknownFields().equals(publishCategorisedLvXxlElement.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public Parser<PublishCategorisedLvXxlElement> getParserForType() {
        return PARSER;
    }
    ...
    public Object newInstance(GeneratedMessageV3.UnusedPrivateParameter unusedPrivateParameter) {
        return new PublishCategorisedLvXxlElement();
    }
    ...
    private PublishCategorisedLvXxlElement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(PublishCategorisedLvXxlElement publishCategorisedLvXxlElement) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(publishCategorisedLvXxlElement);
    }

    public static PublishCategorisedLvXxlElement parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static PublishCategorisedLvXxlElement parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (PublishCategorisedLvXxlElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static PublishCategorisedLvXxlElement parseFrom(ByteString byteString) {
    ...
    private PublishCategorisedLvXxlElement() {
        this.memoizedIsInitialized = (byte) -1;
    }

    public static PublishCategorisedLvXxlElement parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
    ...
    public static PublishCategorisedLvXxlElement parseFrom(byte[] bArr) {
    ...
    public static PublishCategorisedLvXxlElement parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static PublishCategorisedLvXxlElement parseFrom(InputStream inputStream) {
        return (PublishCategorisedLvXxlElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static PublishCategorisedLvXxlElement parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (PublishCategorisedLvXxlElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static PublishCategorisedLvXxlElement parseFrom(CodedInputStream codedInputStream) {
        return (PublishCategorisedLvXxlElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static PublishCategorisedLvXxlElement parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (PublishCategorisedLvXxlElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
