...
public final class EntertainmentLnElement extends GeneratedMessageV3 implements vw0 {
    ...
    private static final EntertainmentLnElement DEFAULT_INSTANCE = new EntertainmentLnElement();
    private static final Parser<EntertainmentLnElement> PARSER = new a();

    /* loaded from: classes2.dex */
    public class a extends AbstractParser<EntertainmentLnElement> {
        @Override // com.google.protobuf.Parser
        public EntertainmentLnElement parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            b newBuilder = EntertainmentLnElement.newBuilder();
            try {
    ...
    /* loaded from: classes2.dex */
    public static final class b extends GeneratedMessageV3.Builder<b> implements vw0 {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return com.glance.spaces.zapp.content.roposo.a.internal_static_com_glance_spaces_zapp_content_roposo_EntertainmentLnElement_descriptor;
        }
        ...
        @Override // com.zapp.oneweatherzapp.vw0
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return com.glance.spaces.zapp.content.roposo.a.internal_static_com_glance_spaces_zapp_content_roposo_EntertainmentLnElement_fieldAccessorTable.ensureFieldAccessorsInitialized(EntertainmentLnElement.class, b.class);
        }
        ...
        public EntertainmentLnElement build() {
            EntertainmentLnElement buildPartial = buildPartial();
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public EntertainmentLnElement buildPartial() {
            EntertainmentLnElement entertainmentLnElement = new EntertainmentLnElement(this, 0);
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV3 = this.titleBuilder_;
            if (singleFieldBuilderV3 == null) {
                entertainmentLnElement.title_ = this.title_;
            } else {
                entertainmentLnElement.title_ = singleFieldBuilderV3.build();
            }
            SingleFieldBuilderV3<Timestamp, Timestamp.b, lv4> singleFieldBuilderV32 = this.timestampBuilder_;
            if (singleFieldBuilderV32 == null) {
                entertainmentLnElement.timestamp_ = this.timestamp_;
            } else {
                entertainmentLnElement.timestamp_ = singleFieldBuilderV32.build();
            }
            SingleFieldBuilderV3<Title, Title.b, tv4> singleFieldBuilderV33 = this.subtitleBuilder_;
            if (singleFieldBuilderV33 == null) {
                entertainmentLnElement.subtitle_ = this.subtitle_;
            } else {
                entertainmentLnElement.subtitle_ = singleFieldBuilderV33.build();
            }
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV34 = this.logoBuilder_;
            if (singleFieldBuilderV34 == null) {
                entertainmentLnElement.logo_ = this.logo_;
            } else {
                entertainmentLnElement.logo_ = singleFieldBuilderV34.build();
            }
            SingleFieldBuilderV3<Tag, Tag.b, dp4> singleFieldBuilderV35 = this.tagBuilder_;
            if (singleFieldBuilderV35 == null) {
                entertainmentLnElement.tag_ = this.tag_;
            } else {
                entertainmentLnElement.tag_ = singleFieldBuilderV35.build();
            }
            SingleFieldBuilderV3<Image, Image.b, yr1> singleFieldBuilderV36 = this.imageBuilder_;
            if (singleFieldBuilderV36 == null) {
                entertainmentLnElement.image_ = this.image_;
            } else {
                entertainmentLnElement.image_ = singleFieldBuilderV36.build();
            }
            onBuilt();
            return entertainmentLnElement;
        }
        ...
        public EntertainmentLnElement getDefaultInstanceForType() {
        ...
        public b mergeFrom(Message message) {
            if (message instanceof EntertainmentLnElement) {
                return mergeFrom((EntertainmentLnElement) message);
            }
            super.mergeFrom(message);
            return this;
        }

        public b mergeFrom(EntertainmentLnElement entertainmentLnElement) {
            if (entertainmentLnElement == EntertainmentLnElement.getDefaultInstance()) {
                return this;
            }
            if (entertainmentLnElement.hasTitle()) {
                mergeTitle(entertainmentLnElement.getTitle());
            }
            if (entertainmentLnElement.hasTimestamp()) {
                mergeTimestamp(entertainmentLnElement.getTimestamp());
            }
            if (entertainmentLnElement.hasSubtitle()) {
                mergeSubtitle(entertainmentLnElement.getSubtitle());
            }
            if (entertainmentLnElement.hasLogo()) {
                mergeLogo(entertainmentLnElement.getLogo());
            }
            if (entertainmentLnElement.hasTag()) {
                mergeTag(entertainmentLnElement.getTag());
            }
            if (entertainmentLnElement.hasImage()) {
                mergeImage(entertainmentLnElement.getImage());
            }
            mergeUnknownFields(entertainmentLnElement.getUnknownFields());
            onChanged();
            return this;
        }
    ...
    public /* synthetic */ EntertainmentLnElement(GeneratedMessageV3.Builder builder, int i) {
        this(builder);
    }

    public static EntertainmentLnElement getDefaultInstance() {
    ...
    public static EntertainmentLnElement parseDelimitedFrom(InputStream inputStream) {
        return (EntertainmentLnElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream);
    }

    public static EntertainmentLnElement parseFrom(ByteBuffer byteBuffer) {
        return PARSER.parseFrom(byteBuffer);
    }

    public static Parser<EntertainmentLnElement> parser() {
        return PARSER;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EntertainmentLnElement)) {
            return super.equals(obj);
        }
        EntertainmentLnElement entertainmentLnElement = (EntertainmentLnElement) obj;
        if (hasTitle() != entertainmentLnElement.hasTitle()) {
            return false;
        }
        if ((hasTitle() && !getTitle().equals(entertainmentLnElement.getTitle())) || hasTimestamp() != entertainmentLnElement.hasTimestamp()) {
            return false;
        }
        if ((hasTimestamp() && !getTimestamp().equals(entertainmentLnElement.getTimestamp())) || hasSubtitle() != entertainmentLnElement.hasSubtitle()) {
            return false;
        }
        if ((hasSubtitle() && !getSubtitle().equals(entertainmentLnElement.getSubtitle())) || hasLogo() != entertainmentLnElement.hasLogo()) {
            return false;
        }
        if ((hasLogo() && !getLogo().equals(entertainmentLnElement.getLogo())) || hasTag() != entertainmentLnElement.hasTag()) {
            return false;
        }
        if ((hasTag() && !getTag().equals(entertainmentLnElement.getTag())) || hasImage() != entertainmentLnElement.hasImage()) {
            return false;
        }
        if ((!hasImage() || getImage().equals(entertainmentLnElement.getImage())) && getUnknownFields().equals(entertainmentLnElement.getUnknownFields())) {
            return true;
        }
        return false;
    }
    ...
    public Parser<EntertainmentLnElement> getParserForType() {
        return PARSER;
    }
    ...
    public Object newInstance(GeneratedMessageV3.UnusedPrivateParameter unusedPrivateParameter) {
        return new EntertainmentLnElement();
    }
    ...
    private EntertainmentLnElement(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static b newBuilder(EntertainmentLnElement entertainmentLnElement) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(entertainmentLnElement);
    }

    public static EntertainmentLnElement parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(byteBuffer, extensionRegistryLite);
    }

    public static EntertainmentLnElement parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (EntertainmentLnElement) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static EntertainmentLnElement parseFrom(ByteString byteString) {
    ...
    private EntertainmentLnElement() {
        this.memoizedIsInitialized = (byte) -1;
    }

    public static EntertainmentLnElement parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
    ...
    public static EntertainmentLnElement parseFrom(byte[] bArr) {
    ...
    public static EntertainmentLnElement parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return PARSER.parseFrom(bArr, extensionRegistryLite);
    }

    public static EntertainmentLnElement parseFrom(InputStream inputStream) {
        return (EntertainmentLnElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream);
    }

    public static EntertainmentLnElement parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (EntertainmentLnElement) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, extensionRegistryLite);
    }

    public static EntertainmentLnElement parseFrom(CodedInputStream codedInputStream) {
        return (EntertainmentLnElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream);
    }

    public static EntertainmentLnElement parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (EntertainmentLnElement) GeneratedMessageV3.parseWithIOException(PARSER, codedInputStream, extensionRegistryLite);
    }
}
