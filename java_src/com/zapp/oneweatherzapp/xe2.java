...
public class xe2 extends pq {
    ...
    public final void C(OutputStream outputStream, int i, int i2) {
        outputStream.write(this.b, F() + i, i2);
    }

    public final boolean D(xe2 xe2Var, int i, int i2) {
        if (i2 <= xe2Var.size()) {
            if (i + i2 <= xe2Var.size()) {
                int F = F() + i2;
                int F2 = F();
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof pq) || size() != ((pq) obj).size()) {
            return false;
        }
        if (size() == 0) {
            return true;
    ...
    public final boolean r() {
        byte[] bArr = this.b;
        if (oo.p(bArr, 0, bArr.length + 0) != 0) {
            return false;
        }
        return true;
    }
    ...
    */
    public final int v(int r9, int r10, int r11) {
        ...
        L9b:
            ...
            goto La1
        L9d:
            int r9 = com.zapp.oneweatherzapp.oo.p(r8, r10, r11)
        La1:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zapp.oneweatherzapp.xe2.v(int, int, int):int");
    }
