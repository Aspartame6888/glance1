...
public final class Alert {
    ...
    public Alert(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10) {
        this.title = str;
    ...
    public static /* synthetic */ Alert copy$default(Alert alert, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, int i, Object obj) {
        String str11;
        String str12;
        String str13;
        String str14;
        ...
        if ((i & 4) != 0) {
            str13 = alert.expireTimestamp;
        } else {
            str13 = str3;
        }
        if ((i & 8) != 0) {
            str14 = alert.messageHeadline;
        } else {
            str14 = str4;
        }
        if ((i & 16) != 0) {
            str15 = alert.messageDescription;
        } else {
            str15 = str5;
        }
        if ((i & 32) != 0) {
            str16 = alert.messageId;
        } else {
            str16 = str6;
        }
        if ((i & 64) != 0) {
        ...
        return alert.copy(str11, str12, str13, str14, str15, str16, str17, str18, str19, str20);
    }
    ...
    public final Alert copy(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10) {
        return new Alert(str, str2, str3, str4, str5, str6, str7, str8, str9, str10);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (dx1.a(this.title, alert.title) && dx1.a(this.severityLevel, alert.severityLevel) && dx1.a(this.expireTimestamp, alert.expireTimestamp) && dx1.a(this.messageHeadline, alert.messageHeadline) && dx1.a(this.messageDescription, alert.messageDescription) && dx1.a(this.messageId, alert.messageId) && dx1.a(this.source, alert.source) && dx1.a(this.startTimestamp, alert.startTimestamp) && dx1.a(this.certainty, alert.certainty) && dx1.a(this.urgency, alert.urgency)) {
            return true;
        }
        return false;
    }
