...
public final class vt3 {
    ...
    public static class a extends RequestBody {
        ...
        @Override // okhttp3.RequestBody
        public final void writeTo(gp gpVar) {
            this.a.writeTo(gpVar);
        }
    }

    public vt3(String str, HttpUrl httpUrl, String str2, Headers headers, MediaType mediaType, boolean z, boolean z2, boolean z3) {
        this.a = str;
        this.b = httpUrl;
        this.c = str2;
        this.g = mediaType;
    ...
    public final void a(String str, String str2) {
        if ("Content-Type".equalsIgnoreCase(str)) {
            try {
                ...
                throw new IllegalArgumentException(q3.a("Malformed content type: ", str2), e);
            }
        }
        this.f.add(str, str2);
    }
