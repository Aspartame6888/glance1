...
public enum InningDivision implements ProtocolMessageEnum {
    ...
    private static final Internal.EnumLiteMap<InningDivision> internalValueMap = new Internal.EnumLiteMap<InningDivision>() { // from class: com.glance.spaces.zapp.content.sports.InningDivision.a
