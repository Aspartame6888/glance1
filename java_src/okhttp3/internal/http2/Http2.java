...
public final class Http2 {
    ...
    static {
        ...
        for (int i2 = 0; i2 < 256; i2++) {
            ...
            dx1.e(binaryString, "toBinaryString(it)");
            strArr[i2] = xk4.w(Util.format("%8s", binaryString), ' ', '0');
        }
        BINARY = strArr;
        ...
        strArr2[8] = "PADDED";
        int i3 = iArr[0];
        strArr2[i3 | 8] = dx1.k("|PADDED", strArr2[i3]);
        ...
        if (i != 2 && i != 3) {
            if (i != 4 && i != 6) {
                if (i != 7 && i != 8) {
                    ...
                    if (i == 5 && (i2 & 4) != 0) {
                        return xk4.x(str, "HEADERS", "PUSH_PROMISE");
                    }
                    if (i == 0 && (i2 & 32) != 0) {
                        return xk4.x(str, "PRIORITY", "COMPRESSED");
                    }
                    return str;
                }
            } else if (i2 == 1) {
