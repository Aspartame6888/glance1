        ...
        public static final class DnsSystem implements Dns {
            ...
            public List<InetAddress> lookup(String str) {
                ...
                try {
                    ...
                    dx1.e(allByName, "getAllByName(hostname)");
                    return b.H(allByName);
                } catch (NullPointerException e) {
                    UnknownHostException unknownHostException = new UnknownHostException(dx1.k(str, "Broken system behaviour for dns lookup of "));
