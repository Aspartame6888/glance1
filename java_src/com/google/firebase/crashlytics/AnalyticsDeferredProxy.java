...
import com.zapp.oneweatherzapp.qh0;
...
public class AnalyticsDeferredProxy {
    ...
    private void init() {
        this.analyticsConnectorDeferred.whenAvailable(new qh0(this));
    }
    ...
    public BreadcrumbSource getDeferredBreadcrumbSource() {
        return new BreadcrumbSource() { // from class: com.zapp.oneweatherzapp.p5
