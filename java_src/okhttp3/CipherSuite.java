...
public final class CipherSuite {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i = 4; i < min; i++) {
                    ...
                    if (charAt != charAt2) {
                        return dx1.h(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
        ...
        TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", ZappWidgetId.L0_ID_SPORTS_NBA_HEADLINES_LN_V2_VALUE);
        TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", ZappWidgetId.L0_ID_SPORTS_MLB_HEADLINES_LN_V2_VALUE);
        TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", ZappWidgetId.L0_ID_TRENDZ_BREAKING_NEWS_MD_V1_VALUE);
        TLS_DH_anon_WITH_AES_128_CBC_SHA256 = companion.init("TLS_DH_anon_WITH_AES_128_CBC_SHA256", ZappWidgetId.L0_ID_TRENDZ_BREAKING_NEWS_LN_V2_VALUE);
        TLS_DH_anon_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DH_anon_WITH_AES_256_CBC_SHA256", ZappWidgetId.L0_ID_TRENDZ_NEWS_ONE_WEATHER_LN_V1_VALUE);
        TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", ZappWidgetId.L0_ID_SHOP_SMART_GADGETS_LN_V1_VALUE);
        TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", ZappWidgetId.L0_ID_SHOP_DAILY_DEAL_MD_V1_VALUE);
        TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", ZappWidgetId.L0_ID_SHOP_SMART_GADGETS_MD_V1_VALUE);
        TLS_PSK_WITH_RC4_128_SHA = companion.init("TLS_PSK_WITH_RC4_128_SHA", ZappWidgetId.L0_ID_SHOP_BUDGET_BUY_MD_V1_VALUE);
        TLS_PSK_WITH_3DES_EDE_CBC_SHA = companion.init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", ZappWidgetId.SPORTS_BDS_LEAGUE_MATCH_XXL_V1_VALUE);
        TLS_PSK_WITH_AES_128_CBC_SHA = companion.init("TLS_PSK_WITH_AES_128_CBC_SHA", ZappWidgetId.SPORTS_BDS_TEAM_MATCH_XXL_V1_VALUE);
        TLS_PSK_WITH_AES_256_CBC_SHA = companion.init("TLS_PSK_WITH_AES_256_CBC_SHA", ZappWidgetId.SPORTS_BDS_HEADLINES_XXL_V1_VALUE);
        TLS_RSA_WITH_SEED_CBC_SHA = companion.init("TLS_RSA_WITH_SEED_CBC_SHA", ZappWidgetId.L0_ID_SPORTS_BDS_ROUNDUP_MXL_V1_VALUE);
        TLS_RSA_WITH_AES_128_GCM_SHA256 = companion.init("TLS_RSA_WITH_AES_128_GCM_SHA256", ZappWidgetId.GLANCE_GLOBAL_LOCATION_PREFERENCE_LH_V1_VALUE);
        TLS_RSA_WITH_AES_256_GCM_SHA384 = companion.init("TLS_RSA_WITH_AES_256_GCM_SHA384", ZappWidgetId.HOME_HOROSCOPE_LH_V1_VALUE);
    ...
    public /* synthetic */ CipherSuite(String str, di0 di0Var) {
        this(str);
    }
    ...
    public final String m370deprecated_javaName() {
