...
public final class EnumValueOptionsKtKt {
    ...
    public static final /* synthetic */ DescriptorProtos.EnumValueOptions copy(DescriptorProtos.EnumValueOptions enumValueOptions, Function110<? super EnumValueOptionsKt.Dsl, k55> function110) {
        dx1.f(enumValueOptions, "<this>");
        dx1.f(function110, "block");
        EnumValueOptionsKt.Dsl.Companion companion = EnumValueOptionsKt.Dsl.Companion;
