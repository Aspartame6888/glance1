...
public final class GameCenterUtilsBridgeImpl {
    ...
    public final String b = "ZIP_GAME_ASSET";

    public GameCenterUtilsBridgeImpl(Context context) {
        this.a = context;
    }

    @JavascriptInterface
    public final String getCommunityToken(boolean z) {
        Object d;
        String str;
        HashMap<String, un3> hashMap = vn3.a;
        String z2 = t6.z("ZIP_GAME_ASSET");
        CommunityRepository communityRepository = new CommunityRepository();
        Context context = this.a;
        if (context == null) {
            return null;
        }
        if (z || communityRepository.b() == null) {
            d = gp1.d(EmptyCoroutineContext.INSTANCE, new GameCenterUtilsBridgeImpl$getCommunityToken$1$1(communityRepository, context, z2, null));
            str = (String) d;
        } else {
            str = communityRepository.b();
        }
        return str;
    }
    ...
    public final void launchIntentAfterUnlock(final String str, final String str2) {
        Context context = this.a;
        if (context != null) {
            a.a(context, new ce1<k55>() { // from class: com.glance.pwaSdkIntegrator.game.jsbridges.GameCenterUtilsBridgeImpl$launchIntentAfterUnlock$1$1
