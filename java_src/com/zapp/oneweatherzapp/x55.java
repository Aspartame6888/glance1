...
public final class x55 {
    public static final Logger a = Logger.getLogger(x55.class.getName());
    ...
    public static final class b extends e {
        @Override // com.zapp.oneweatherzapp.x55.e
        ...
        public final void k(Object obj, long j, boolean z) {
            if (x55.h) {
                x55.q(obj, j, z ? (byte) 1 : (byte) 0);
            } else {
                x55.r(obj, j, z ? (byte) 1 : (byte) 0);
            }
        }
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zapp.oneweatherzapp.x55.<clinit>():void");
    }
