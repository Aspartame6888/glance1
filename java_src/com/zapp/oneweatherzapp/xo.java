...
/* compiled from: BubbleErrorHandlingWebViewClient.kt */
/* loaded from: classes.dex */
public abstract class xo extends WebViewClient {
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        if (webResourceRequest.isForMainFrame()) {
            ...
            dx1.e(webResourceError.getDescription(), "getDescription(...)");
            boolean s = kotlin.collections.b.s(yo.a, Integer.valueOf(webResourceError.getErrorCode()));
