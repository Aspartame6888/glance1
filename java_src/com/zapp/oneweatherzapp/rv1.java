    ...
    */
    public static int b(int r5, int r6, java.math.RoundingMode r7) {
        ...
        Le:
            ...
            r2 = 1
            r5 = r5 | r2
            int[] r3 = com.zapp.oneweatherzapp.rv1.a.a
            int r4 = r7.ordinal()
            r3 = r3[r4]
            r4 = 0
            switch(r3) {
        ...
        L63:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zapp.oneweatherzapp.rv1.b(int, int, java.math.RoundingMode):int");
    }
    ...
    public static int c(int i, RoundingMode roundingMode) {
        ...
        throw new IllegalArgumentException(cg0.b("x (", i, ") must be > 0"));
    }
}
