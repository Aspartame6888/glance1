...
public final class ApiKtKt {
    ...
    public static final /* synthetic */ Api copy(Api api, Function110<? super ApiKt.Dsl, k55> function110) {
        dx1.f(api, "<this>");
        dx1.f(function110, "block");
        ApiKt.Dsl.Companion companion = ApiKt.Dsl.Companion;
