...
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lcom/zapp/oneweatherzapp/ea0;", "Lcom/zapp/oneweatherzapp/sb;", "Lcom/zapp/oneweatherzapp/tn1;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
@we0(c = "com.glance.sportszapp.domain.TeamStatsUseCase$executeNHLTeamStats$2", f = "TeamStatsUseCase.kt", l = {45}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class TeamStatsUseCase$executeNHLTeamStats$2 extends SuspendLambda implements Function2<ea0, j90<? super sb<tn1>>, Object> {
    ...
    public TeamStatsUseCase$executeNHLTeamStats$2(a aVar, int i, int i2, int i3, int i4, j90<? super TeamStatsUseCase$executeNHLTeamStats$2> j90Var) {
        super(2, j90Var);
        this.this$0 = aVar;
        this.$teamId = i;
        this.$leagueId = i2;
    ...
    public final j90<k55> create(Object obj, j90<?> j90Var) {
        return new TeamStatsUseCase$executeNHLTeamStats$2(this.this$0, this.$teamId, this.$leagueId, this.$splitId, this.$eventTypeId, j90Var);
    }

    @Override // com.zapp.oneweatherzapp.Function2
    public final Object invoke(ea0 ea0Var, j90<? super sb<tn1>> j90Var) {
        return ((TeamStatsUseCase$executeNHLTeamStats$2) create(ea0Var, j90Var)).invokeSuspend(k55.a);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        String str;
        List<PlayerGoaltendingStatsNhlItem> list;
        ...
        if (sbVar instanceof vb) {
            ...
            List<PlayerSkatingStatsNhlItem> list2 = null;
            if (content != null) {
            ...
            if (content2 != null) {
                list = content2.getPlayerGoaltendingStatsNhl();
            } else {
                list = null;
            }
            StatsContentResponse content3 = ((TeamStatsResponse) t).getContent();
            if (content3 != null) {
                list2 = content3.getPlayerSkatingStatsNhl();
            }
            return new vb(new tn1(str, list, list2));
        }
