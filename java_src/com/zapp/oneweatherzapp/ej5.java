...
public final class ej5 {
    ...
    public ej5(CharSequence charSequence, int i, Locale locale) {
        boolean z;
        this.a = charSequence;
        boolean z2 = true;
        ...
        if (z) {
            if ((i < 0 || i > charSequence.length()) ? false : z2) {
                ...
                wordInstance.setText(new su(charSequence, i));
                return;
            }
    ...
    public final void a(int i) {
        ...
        throw new IllegalArgumentException(xi.a(hy3.a("Invalid offset: ", i, ". Valid range is [", i2, " , "), i3, ']').toString());
    }
