...
public class GradientStrokeContent extends BaseStrokeContent {
    ...
    private final ni2<LinearGradient> linearGradientCache;
    private final String name;
    private final ni2<RadialGradient> radialGradientCache;
    private final BaseKeyframeAnimation<PointF, PointF> startPointAnimation;
    private final GradientType type;

    public GradientStrokeContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, GradientStroke gradientStroke) {
        super(lottieDrawable, baseLayer, gradientStroke.getCapType().toPaintCap(), gradientStroke.getJoinType().toPaintJoin(), gradientStroke.getMiterLimit(), gradientStroke.getOpacity(), gradientStroke.getWidth(), gradientStroke.getLineDashPattern(), gradientStroke.getDashOffset());
        this.linearGradientCache = new ni2<>();
        this.radialGradientCache = new ni2<>();
    ...
    private RadialGradient getRadialGradient() {
        ...
        RadialGradient radialGradient = new RadialGradient(value.x, value.y, (float) Math.hypot(value2.x - f, value2.y - f2), applyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
