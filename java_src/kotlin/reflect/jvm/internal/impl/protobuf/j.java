...
public class j<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final int a;
    public List<j<K, V>.b> b = Collections.emptyList();
    public Map<K, V> c = Collections.emptyMap();
    public boolean d;
    public volatile j<K, V>.d e;
    ...
    public static class a {
        ...
        /* loaded from: classes3.dex */
        public static class C0232a implements Iterator<Object> {
    ...
    public class c implements Iterator<Map.Entry<K, V>> {
        ...
        public final Iterator<Map.Entry<K, V>> a() {
            if (this.c == null) {
                this.c = j.this.c.entrySet().iterator();
            }
            return this.c;
        }
        ...
        @Override // java.util.Iterator
        public final boolean hasNext() {
            if (this.a + 1 < j.this.b.size() || a().hasNext()) {
                return true;
            }
            return false;
        }
    ...
    public class d extends AbstractSet<Map.Entry<K, V>> {
        ...
        public final boolean add(Object obj) {
            ...
            if (!contains(entry)) {
                Object value = entry.getValue();
                j.this.g((Comparable) entry.getKey(), value);
                return true;
            }
            return false;
        }
    ...
    public final V g(K k, V v) {
        ...
        if (this.b.size() == i) {
            j<K, V>.b remove = this.b.remove(i - 1);
