...
public final class sc1 extends wc1 {
    ...
    public static boolean s(Transition transition) {
        if (wc1.h(transition.getTargetIds()) && wc1.h(transition.getTargetNames()) && wc1.h(transition.getTargetTypes())) {
            return false;
        }
        return true;
    }
    ...
    public final void b(Object obj, ArrayList<View> arrayList) {
        ...
        } else if (!s(transition) && wc1.h(transition.getTargets())) {
    ...
    public final void l(Object obj, Object obj2, ArrayList arrayList, Object obj3, ArrayList arrayList2) {
        ((Transition) obj).addListener(new tc1(this, obj2, arrayList, obj3, arrayList2));
    }
    ...
    public final void m(View view, Object obj) {
        if (view != null) {
            Rect rect = new Rect();
            wc1.g(view, rect);
            ((Transition) obj).setEpicenterCallback(new rc1(rect));
        }
    }
    ...
    @Override // com.zapp.oneweatherzapp.wc1
    public final void o(Object obj, xj0 xj0Var) {
        ((Transition) obj).addListener(new uc1(xj0Var));
    }
