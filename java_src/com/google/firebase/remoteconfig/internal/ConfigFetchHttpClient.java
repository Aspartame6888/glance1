...
import com.zapp.oneweatherzapp.z83;
...
public class ConfigFetchHttpClient {
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map<String, String> map, Long l) {
        ...
        if (str != null) {
            ...
            try {
                ...
                if (packageInfo != null) {
                    ...
                    hashMap.put(RemoteConfigConstants.RequestFieldKey.APP_BUILD, Long.toString(z83.b(packageInfo)));
                }
            } catch (PackageManager.NameNotFoundException unused) {
            }
            hashMap.put(RemoteConfigConstants.RequestFieldKey.PACKAGE_NAME, this.context.getPackageName());
            hashMap.put(RemoteConfigConstants.RequestFieldKey.SDK_VERSION, "21.1.2");
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            if (a == null) {
                mu0.c(FirebaseRemoteConfig.TAG, "Could not get fingerprint hash for package: " + this.context.getPackageName());
                return null;
            }
            return vx4.b(a);
        } catch (PackageManager.NameNotFoundException e) {
            mu0.d(FirebaseRemoteConfig.TAG, "No such package: " + this.context.getPackageName(), e);
            return null;
        }
    }
