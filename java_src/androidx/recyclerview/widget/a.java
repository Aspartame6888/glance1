        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i2 != 1) {
                if (i2 != 2) {
                    if (i2 != 4) {
                        if (i2 == 8) {
                            RecyclerView.f fVar = (RecyclerView.f) interfaceC0060a;
                            fVar.a(bVar);
                            int i3 = bVar.b;
                            int i4 = bVar.d;
                        ...
                        RecyclerView.f fVar2 = (RecyclerView.f) interfaceC0060a;
                        fVar2.a(bVar);
                        int i5 = bVar.b;
                        int i6 = bVar.d;
                        Object obj = bVar.c;
                    ...
                    RecyclerView.f fVar3 = (RecyclerView.f) interfaceC0060a;
                    fVar3.a(bVar);
                    int i7 = bVar.b;
                    int i8 = bVar.d;
                ...
                RecyclerView.f fVar4 = (RecyclerView.f) interfaceC0060a;
                fVar4.a(bVar);
                int i9 = bVar.b;
                int i10 = bVar.d;
