...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) {
        ...
        dx1.e(removeFirst, "queue.removeFirst()");
        ...
        while (i < 9) {
            ...
            if (findByIssuerAndSignature != null) {
                if (arrayList.size() > 1 || !dx1.a(x509Certificate, findByIssuerAndSignature)) {
                ...
                throw new SSLPeerUnverifiedException(dx1.k(x509Certificate, "Failed to find a trusted cert that signed "));
            }
        }
        throw new SSLPeerUnverifiedException(dx1.k(arrayList, "Certificate chain too long: "));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof BasicCertificateChainCleaner) && dx1.a(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex)) {
            return true;
        }
        return false;
    }
