...
public final class xv extends Drawable implements Animatable {
    ...
    public xv(Context context) {
        ...
        ofFloat.addUpdateListener(new vv(this, aVar));
        ofFloat.setRepeatCount(-1);
        ofFloat.setRepeatMode(1);
        ofFloat.setInterpolator(g);
        ofFloat.addListener(new wv(this, aVar));
        this.d = ofFloat;
    }
    ...
    public final void a(float f, a aVar, boolean z) {
        ...
        if (this.f) {
            ...
            aVar.f = f4;
            float f5 = aVar.m;
            aVar.g = d3.a((float) (Math.floor(aVar.m / 0.8f) + 1.0d), f5, f, f5);
        } else if (f != 1.0f || z) {
            float f6 = aVar.m;
            ...
            if (i2 < 0) {
                ...
                f2 = (h21Var.getInterpolation(f / 0.5f) * 0.79f) + 0.01f + interpolation;
            } else {
                float f7 = aVar.k + 0.79f;
                interpolation = f7 - (((1.0f - h21Var.getInterpolation((f - 0.5f) / 0.5f)) * 0.79f) + 0.01f);
                f2 = f7;
            }
            aVar.e = interpolation;
            aVar.f = f2;
            aVar.g = (0.20999998f * f) + f6;
            this.b = (f + this.e) * 216.0f;
        }
    }
