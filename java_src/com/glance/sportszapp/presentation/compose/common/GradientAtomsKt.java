...
public final class GradientAtomsKt {
    public static final vd2 a = uo.a.b(g65.g(new oz(oz.i), new oz(tz.e)), 0.0f, 0.0f, 14);
    ...
    public static final void a(final yn ynVar, final float f, uo uoVar, Composer composer, final int i, final int i2) {
        ...
        Modifier f2;
        dx1.f(ynVar, "<this>");
        androidx.compose.runtime.a i7 = composer.i(519105850);
        ...
        sq3 Z = i7.Z();
        if (Z != null) {
            Z.d = new Function2<Composer, Integer, k55>() { // from class: com.glance.sportszapp.presentation.compose.common.GradientAtomsKt$GradientBottomToTop$1
