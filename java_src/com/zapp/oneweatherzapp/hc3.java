...
public final class hc3 {
    ...
    */
    public static com.zapp.oneweatherzapp.hc3.a[] c(java.lang.String r17) {
        /*
            Method dump skipped, instructions count: 276
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zapp.oneweatherzapp.hc3.c(java.lang.String):com.zapp.oneweatherzapp.hc3$a[]");
    }
    ...
    public static Path d(String str) {
        ...
        if (c != null) {
            try {
                ...
                throw new RuntimeException(q3.a("Error in parsing ", str), e);
            }
        }
        return null;
    }
    ...
    public static class a {
        ...
        public static void a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d19 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                mu0.h("PathParser", " Points are coincident");
                return;
            }
            double d20 = (1.0d / d19) - 0.25d;
            if (d20 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                mu0.h("PathParser", "Points are too far apart " + d19);
