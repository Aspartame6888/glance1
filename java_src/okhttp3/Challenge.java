...
public final class Challenge {
    ...
    public Challenge(String str, Map<String, String> map) {
        ...
        dx1.e(unmodifiableMap, "unmodifiableMap<String?, String>(newAuthParams)");
        this.authParams = unmodifiableMap;
    }

    /* renamed from: -deprecated_authParams  reason: not valid java name */
    public final Map<String, String> m366deprecated_authParams() {
        return this.authParams;
    }

    /* renamed from: -deprecated_charset  reason: not valid java name */
    public final Charset m367deprecated_charset() {
        return charset();
    }

    /* renamed from: -deprecated_realm  reason: not valid java name */
    public final String m368deprecated_realm() {
        return realm();
    }

    /* renamed from: -deprecated_scheme  reason: not valid java name */
    public final String m369deprecated_scheme() {
        return this.scheme;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Challenge) {
            ...
            if (dx1.a(challenge.scheme, this.scheme) && dx1.a(challenge.authParams, this.authParams)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return this.authParams.hashCode() + a4.b(this.scheme, 899, 31);
    }
    ...
    public final Challenge withCharset(Charset charset) {
        ...
        LinkedHashMap E = d.E(this.authParams);
        String name = charset.name();
        dx1.e(name, "charset.name()");
        E.put("charset", name);
