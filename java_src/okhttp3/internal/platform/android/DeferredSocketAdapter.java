...
public final class DeferredSocketAdapter implements SocketAdapter {
    ...
    public DeferredSocketAdapter(Factory factory) {
        dx1.f(factory, "socketAdapterFactory");
