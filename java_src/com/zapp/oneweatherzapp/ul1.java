...
import com.glance.newszapp.viewmore.NewsZappFragment;
import dagger.hilt.android.internal.managers.ViewComponentManager$FragmentContextWrapper;
/* compiled from: Hilt_NewsZappFragment.java */
/* loaded from: classes.dex */
public abstract class ul1 extends hm5 implements ig1 {
    ...
    public final void C(Activity activity) {
        ...
        if (!this.w0) {
            this.w0 = true;
            NewsZappFragment newsZappFragment = (NewsZappFragment) this;
            ((j03) e()).u();
        }
    }
